...
def basic_function_and_update(schema_name, table_name, column_name, sql_func, data_type, nada_column):
    ...
    update_string = update_nada_profilering(schema_name, table_name, column_name, nada_column, 'answer')
...
def chained_function_and_update(schema_name, table_name, column_name, sql_funcs, data_type, nada_column):
    declare_string = declare_variables([{'name': 'answer', 'data_type': data_type}])
...
def count_value_function_and_update(schema_name, table_name, column_name, value, nada_column):
