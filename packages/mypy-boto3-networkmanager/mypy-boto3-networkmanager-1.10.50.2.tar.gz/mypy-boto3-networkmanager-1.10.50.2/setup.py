...
class PostInstallCommand(install):
    def run(self):
        ...
        try:
            ...
            add_package_to_index("mypy-boto3-networkmanager")
            print("mypy_boto3: Package mypy-boto3-networkmanager added to index")
...
setup(
    ...
    description="Type annotations for boto3.NetworkManager 1.10.50 service.",
    classifiers=[
