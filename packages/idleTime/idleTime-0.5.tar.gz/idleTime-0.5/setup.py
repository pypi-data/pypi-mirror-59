...
setup(
  ...
  download_url = 'https://github.com/TheSinOfSloth/idle_time/archive/v_04.tar.gz',    # I explain this later on
  keywords = ['idle', 'time', 'xprintidle','idleTime'],   # Keywords that define your package best
