...
def write_object(value, bucket=None, key=None,
    ...
    if type(value) is dict:
        ...
        return write(json.dumps(value, default=json_default, cls=utils.JSONEncoder), bucket, key, uri,
    ...
    # Text
        ...
        for row in value:
            if type(row) is dict:
                buff.write(json.dumps(row, default=json_default, cls=utils.JSONEncoder) + newline)
            else:
