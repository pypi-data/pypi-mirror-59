    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diagnostic_type', models.CharField(choices=[('rapid_test', 'Rapid test'), ('microscopy', 'Microscopy')], max_length=15, verbose_name='Diagnostic performed by ...')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='meta_subjec_subject_038dbe_idx'),
        ),
    ]
