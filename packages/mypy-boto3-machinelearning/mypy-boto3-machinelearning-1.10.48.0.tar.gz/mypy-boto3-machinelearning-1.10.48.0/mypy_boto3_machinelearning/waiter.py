...
class BatchPredictionAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [BatchPredictionAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/machinelearning.html#MachineLearning.Waiter.BatchPredictionAvailable.wait)
        """
...
class DataSourceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DataSourceAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/machinelearning.html#MachineLearning.Waiter.DataSourceAvailable.wait)
        """
...
class EvaluationAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [EvaluationAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/machinelearning.html#MachineLearning.Waiter.EvaluationAvailable.wait)
        """
...
class MLModelAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [MLModelAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/machinelearning.html#MachineLearning.Waiter.MLModelAvailable.wait)
        """
