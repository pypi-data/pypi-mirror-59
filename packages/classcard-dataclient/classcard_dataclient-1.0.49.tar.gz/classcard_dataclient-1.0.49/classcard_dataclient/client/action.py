...
from ..utils.data_req import (
    ...
    get_school_by_id, get_school_by_name, get_school_by_code, create_classroom_req, create_subject_req,
    update_student_req, update_teacher_req, create_school_req, update_school_req)
