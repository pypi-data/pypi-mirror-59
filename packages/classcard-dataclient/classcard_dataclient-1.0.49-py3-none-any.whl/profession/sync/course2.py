...
from classcard_dataclient.models.course import CourseV2, CourseTableManagerV2, CourseCategory, WalkingModeSet
...
class CourseSyncV2(BaseSync2):
    ...
    def sync(self):
        ...
        course_table = CourseTableManagerV2(name=response['semester'], number=get_md5_hash(response['semester'])[:20],
                                            rest_name=rest_table.name,  walking_mode=WalkingModeSet.WALKING,
        ...
        self.client.active_course_table(self.school_id, course_table, delete_other=True)