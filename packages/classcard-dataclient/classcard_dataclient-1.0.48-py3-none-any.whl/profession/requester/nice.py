...
# nice_requester = NiceRequester("3532", host="xgk.lanzhou.edu.cn:20952/schoolscheduleserv/integration",
#                                protocol="https")
# nice_requester.get_student_list()
# list(filter(lambda c: c['locationName'] == '高二5班' and c['weekDay'] == 1,res['schedule']))