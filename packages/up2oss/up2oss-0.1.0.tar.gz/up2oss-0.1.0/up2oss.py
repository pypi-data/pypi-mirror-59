...
<fieldset class="layui-elem-field">
    ...
    <div class="layui-field-box">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><b style="color: red;">*</b> AccessKey ID</label>
            <div class="layui-input-block">
                <input type="text" name="aliyun_ak" value="{{ g.site.aliyun_ak }}" placeholder="阿里云个人密钥的AK，可以使用RAM用户的密钥"
                    autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label"><b style="color: red;">*</b> Access Key Secret</label>
            <div class="layui-input-block">
                <input type="password" name="aliyun_sk" value="{{ g.site.aliyun_sk }}" placeholder="阿里云个人密钥的SK，如果使用RAM请确保有OSS管理权限"
                    autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
