...
class ListCloudFrontOriginAccessIdentitiesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCloudFrontOriginAccessIdentities.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/cloudfront.html#CloudFront.Paginator.ListCloudFrontOriginAccessIdentities.paginate)
        """
...
class ListDistributionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDistributions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/cloudfront.html#CloudFront.Paginator.ListDistributions.paginate)
        """
...
class ListInvalidationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListInvalidations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/cloudfront.html#CloudFront.Paginator.ListInvalidations.paginate)
        """
...
class ListStreamingDistributionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListStreamingDistributions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/cloudfront.html#CloudFront.Paginator.ListStreamingDistributions.paginate)
        """
