...
class Conf():
    ...
    def setup(cls, settings):
        ...
        #bo template
        cls.listusertemplate = settings.get("ppss_auth.listusertemplate", cls.tplpath("listuser") )
        cls.editusertemplate = settings.get("ppss_auth.editusertemplate", cls.tplpath("edituser") )
        cls.listgrouptemplate = settings.get("ppss_auth.listgrouptemplate", cls.tplpath("listgroup") )
        cls.editgrouptemplate = settings.get("ppss_auth.editgrouptemplate", cls.tplpath("editgroup") )
        cls.listpermtemplate = settings.get("ppss_auth.listpermtemplate", cls.tplpath("listperm") )
        cls.editpermtemplate = settings.get("ppss_auth.editpermtemplate", cls.tplpath("editperm") )
