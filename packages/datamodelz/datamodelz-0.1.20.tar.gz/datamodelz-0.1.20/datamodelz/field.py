...
class DateField(BaseTypeField):
    ...
    def __lt__(self, other):
        ...
        if isinstance(other, datetime.datetime.__class__):
    ...
    def __add__(self, other):
        ...
        if isinstance(other, datetime.datetime.__class__):
            ...
            return new
        if isinstance(other, timedelta.__class__):
            new.value = self.value.replace(tzinfo=utc) + other
            return new
        if isinstance(other, relativedelta.__class__):
            new.value = self.value.replace(tzinfo=utc) + other
            return self
    ...
    def add_frequency(self, frequency: str):
        ...
        new = self.copy()
        new += self.convert_frequency(frequency)
        return copy
