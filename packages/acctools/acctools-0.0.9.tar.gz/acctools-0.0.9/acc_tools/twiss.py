...
class GraphicPlot:
    ...
    def plot_structure(data_frame):
        ...
        mag.opts(width=700, height=300, show_frame=False, show_title=False, xaxis=None, yaxis=None, show_grid=True,
                 default_tools=['box_zoom', 'pan', 'wheel_zoom', 'reset'], tools=['xbox_zoom, xpan', hover],
