...
def replace_text_files(replace_keys, files, type='text', casesesitive=False):
  """
...
if __name__ == "__main__":
  ...
  result = replace_text_files([('k','XX_K_XX'), ('b', 'b_xxx')], ['R:/1.txt','R:/2.txt','R:/3.txt'] )
