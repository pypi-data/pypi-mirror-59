...
__jsii_assembly__ = jsii.JSIIAssembly.load("cdk-spa-deploy", "0.3.0", __name__, "cdk-spa-deploy@0.3.0.jsii.tgz")
...
__all__ = ["SPADeploy", "SPADeployConfig", "SPAGlobalConfig", "__jsii_assembly__"]
