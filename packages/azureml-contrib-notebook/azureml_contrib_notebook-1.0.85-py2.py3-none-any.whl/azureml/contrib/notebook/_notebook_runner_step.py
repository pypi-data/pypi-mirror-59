...
from azureml.pipeline.core import InputPortBinding, PortDataReference, PipelineDataset
...
class NotebookRunnerStep(_PythonScriptStepBase):
    ...
    def _get_io_name_by_type(io_object):
        if (isinstance(io_object, PipelineData) or
                ...
                isinstance(io_object, Dataset) or
                isinstance(io_object, PipelineDataset)):
            ...
            raise TypeError(
                ...
                "Dataset, PipelineDataset, DataReference, PortDataReference")
