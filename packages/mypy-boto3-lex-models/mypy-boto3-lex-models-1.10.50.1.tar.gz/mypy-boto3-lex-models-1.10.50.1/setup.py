...
class PostInstallCommand(install):
    def run(self):
        ...
        try:
            ...
            add_package_to_index("mypy-boto3-lex-models")
            print("mypy_boto3: Package mypy-boto3-lex-models added to index")
...
setup(
    ...
    description="Type annotations for boto3.LexModelBuildingService 1.10.50 service.",
    classifiers=[
