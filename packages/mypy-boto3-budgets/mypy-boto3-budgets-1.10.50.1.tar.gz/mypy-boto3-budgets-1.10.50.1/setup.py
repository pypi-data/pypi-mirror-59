...
class PostInstallCommand(install):
    def run(self):
        ...
        try:
            ...
            add_package_to_index("mypy-boto3-budgets")
            print("mypy_boto3: Package mypy-boto3-budgets added to index")
...
setup(
    ...
    description="Type annotations for boto3.Budgets 1.10.50 service.",
    classifiers=[
