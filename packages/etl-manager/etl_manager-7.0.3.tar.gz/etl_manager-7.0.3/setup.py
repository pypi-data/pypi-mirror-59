...
package_data = \
{'': ['*'],
 'etl_manager': ['specs/avro_specific.json',
                 'specs/avro_specific.json',
                 'specs/avro_specific.json',
                 'specs/avro_specific.json',
                 'specs/avro_specific.json',
                 'specs/avro_specific.json',
                 ...
                 'specs/base.json',
                 'specs/base.json',
                 'specs/csv_quoted_nodate_specific.json',
                 'specs/csv_quoted_nodate_specific.json',
                 'specs/csv_quoted_nodate_specific.json',
                 'specs/csv_quoted_nodate_specific.json',
                 'specs/csv_quoted_nodate_specific.json',
