...
class GeneralRelationalDatasetPipeline(BasePipeline):
    ...
    CHALLENGE_PROBLEMS = ['38_sick_MIN_METADATA', 'LL1_VTXC_1369_synthetic_MIN_METADATA', '66_chlorineConcentration_MIN_METADATA',
                          '59_umls_MIN_METADATA', '57_hypothyroid_MIN_METADATA', '27_wordLevels_MIN_METADATA',
                          '196_autoMpg_MIN_METADATA', '185_baseball_MIN_METADATA']
