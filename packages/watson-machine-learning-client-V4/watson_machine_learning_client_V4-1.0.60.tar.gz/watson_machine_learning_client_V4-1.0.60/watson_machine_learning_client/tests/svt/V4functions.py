...
class TestAIFunction(unittest.TestCase):
    ...
    def test_07_create_deployment(self):
        ...
        deployment = self.client.deployments.create(artifact_uid=TestAIFunction.function_uid, meta_props={self.client.deployments.ConfigurationMetaNames.NAME:"Test deployment", self.client.deployments.ConfigurationMetaNames.ONLINE:{} },  asynchronous=False)
    ...
    def test_08_update_deployment(self):
        ...
        self.client.deployments.update(TestAIFunction.deployment_uid, function_props)
    ...
    def test_10_score(self):
        scoring_data = {self.client.deployments.ScoringMetaNames.INPUT_DATA : {"fields": ["x","y"],"values": [[2.0, 2.0],[99.0,99.0]]}}
