...
def per_node_estimation(i, gr, frm, to, templ, c, entity, st_pl, typ, view, crt, w, way, full=200):
    ids, exes, clust, bls = templ.get_ex(gr, i, frm, c, entity=entity, stab=st_pl, typ=typ, view=view, criterion=crt, w=w, way=way, full=full)
