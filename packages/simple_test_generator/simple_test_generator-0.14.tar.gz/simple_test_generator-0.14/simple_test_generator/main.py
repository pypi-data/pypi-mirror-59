...
def is_function(param):
    ...
    isinstance(param, (types.FunctionType, types.BuiltinFunctionType, types.MethodType, types.BuiltinMethodType))
...
def test_simple_test_generator_test_cases(fn, args, kwargs, expected):
    ...
    if isinstance(actual, GeneratorType):
