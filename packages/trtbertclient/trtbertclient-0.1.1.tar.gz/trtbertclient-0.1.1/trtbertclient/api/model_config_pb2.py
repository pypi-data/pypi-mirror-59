...
_MODELOPTIMIZATIONPOLICY = _descriptor.Descriptor(
  ...
  nested_types=[_MODELOPTIMIZATIONPOLICY_GRAPH, _MODELOPTIMIZATIONPOLICY_CUDA, _MODELOPTIMIZATIONPOLICY_EXECUTIONACCELERATORS, ],
  enum_types=[
