...
from trtbertclient.api import model_config_pb2 as model__config__pb2
...
_SHAREDMEMORYREGION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shared_memory_key', full_name='nvidia.inferenceserver.SharedMemoryRegion.shared_memory_key', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='offset', full_name='nvidia.inferenceserver.SharedMemoryRegion.offset', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
