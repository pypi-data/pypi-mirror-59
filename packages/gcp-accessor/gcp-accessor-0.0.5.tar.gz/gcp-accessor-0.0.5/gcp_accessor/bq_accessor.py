...
class BigQueryAccessor:
    def __init__(self):
        ...
        if "GOOGLE_APPLICATION_CREDENTIALS" in os.environ:
            ...
            if not os.environ.get("GOOGLE_APPLICATION_CREDENTIALS"):
                ...
                bq_client = bigquery.Client.from_service_account_json(json_key_file)
        else:
    ...
    def get_table_name(self, dataset):
        ...
        try:
            table_names = [
                table.table_id for table in self.bq_client.list_tables(dataset)]
        except Exception:
    ...
    def create_table_from_json(self, path_schema_file, dataset, table_name):
        ...
        if not path_schema_file:
            raise Exception(
                "Path to schema file is not correct or it does not exist")
        ...
        for schema in table_schema:
            ...
            if "fields" in list(tuple(schema)):
                ...
                fields = ()
            SCHEMA.append(
                bigquery.SchemaField(name, type, mode=mode,
        ...
        try:
            ...
            raise Exception(
                "Table could not successfully be created on bigquery")
    ...
    def load_data_from_gcs(
        ...
        try:
            ...
            raise Exception(
                "Table could successfully not be loaded on bigquery")
