...
class MaskCheck(object):
    def __init__(self, path, maskpath, percent=1, win=None, label=None, cropsize=96):
        ...
        self.raw_crop, self.mask_crop, pad, self.cropsize = self._crop(raw, mask, cropsize)
    ...
    def _crop(self, raw, mask, cropsize):
        """
        get crop size
        """
