...
__all__ = ['extract_tag', 'contains_tag', 'is_nbx', 'is_nbx_cell', 'is_magic_or_shell', 'strip', 'parse_xarg', 'Bunch',
           'load_nb', 'parse_src', 'parse_nbx_cell', 'concat', 'unzip', 'negate', 'is_constarg', 'get_items',
           'not_constarg', 'parse_nb', 'get_item', 'check_parsed_nb', 'NbxBundle', 'BUNDLE_SUMMARY']
...
def parse_nb(nb):
    ...
    xargs, xbody = reduce(concat, map(parse_nbx_cell, nbx_cells))
    xargs = list(map(parse_xarg, xargs))
