...
#        "temperature": "27080",
    ...
    def set_location_group(self, group, time_to_live_s, vers,
                              gateways,gateway_addr=None, acked=True,
                           time_to_live_s=60.0, port=0, priority=10):
        """
    ...
    def multicast_set_location_group(cls, group, time_to_live_s, vers,
                                     gateways, time_to_live_s=60.0, port=0,
                                     priority=10):
        """
        Sends a SET_LOCATION_GROUP message
    ...
    @classmethod
    def set_conn_timeout(self, interval, time_to_live_s, vers, gateways,
                         time_to_live_s=60.0, port=0, priority=10):
        """
        Sends a SET_CONN_TIMEOUT message
    ...
    def multicast_trigger_assert(cls, time_to_live_s, vers, gateways,
                                 time_to_live_s=60, port=0, priority=10):
        """
        Triggers an assert in the AP
...
class NordicAccessPoint(AccessPoint):
    ...
    @classmethod
    def mulicast_configuration_query(cls, uuid=None, time_to_live_s, vers,
                                     gateways, port=0, priority=10):
        """ Sends a message targeted at the SymBLE endnode to the AP.
    ...
    @classmethod
    def multicast_config_ble_front_end(cls, enable, antenna, time_to_live_s, vers,
                                       gateways, port=0, priority=10):
        """
        Sends a CONFIG_BLE_FRONT_END message
    ...
    @classmethod
    def set_network_token(cls, net_tok, time_to_live_s, vers,
                          gateways, port=0, priority=10):
    ...
    @classmethod
    def multicast_set_dl_band(cls, edge_lower, edge_upper, edge_guard, edge_ch_step,
                              edge_ch_offset, time_to_live_s, vers, gateways,
                              port=0, priority=10):
        """
        Sets the Downlink Link Band Configuration for the Symphony Link Module.
