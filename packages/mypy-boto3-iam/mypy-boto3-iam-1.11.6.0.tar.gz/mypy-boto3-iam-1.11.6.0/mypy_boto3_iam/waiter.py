...
class InstanceProfileExistsWaiter(Boto3Waiter):
    ...
    def wait(self, InstanceProfileName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [InstanceProfileExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/iam.html#IAM.Waiter.InstanceProfileExists.wait)
        """
...
class PolicyExistsWaiter(Boto3Waiter):
    ...
    def wait(self, PolicyArn: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [PolicyExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/iam.html#IAM.Waiter.PolicyExists.wait)
        """
...
class RoleExistsWaiter(Boto3Waiter):
    ...
    def wait(self, RoleName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [RoleExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/iam.html#IAM.Waiter.RoleExists.wait)
        """
...
class UserExistsWaiter(Boto3Waiter):
    ...
    def wait(self, UserName: str = None, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [UserExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/iam.html#IAM.Waiter.UserExists.wait)
        """
