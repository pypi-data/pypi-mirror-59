...
def select_token(required_auth=RequiredAuth.NONE):
    if required_auth == RequiredAuth.APP:
        if not _globals.app_token or _globals.app_token == "":
        ...
        if not _globals.user_token or _globals.user_token == "":
        ...
        if (not _globals.app_token or _globals.app_token == "") and (not _globals.user_token or _globals.user_token == ""):
