...
class PIClient:
    """
    [PI.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.4/reference/services/pi.html#PI.Client)
    """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.4/reference/services/pi.html#PI.Client.can_paginate)
        """
    ...
    def describe_dimension_keys(
        ...
        """
        [Client.describe_dimension_keys documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.4/reference/services/pi.html#PI.Client.describe_dimension_keys)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.4/reference/services/pi.html#PI.Client.generate_presigned_url)
        """
    ...
    def get_resource_metrics(
        ...
        """
        [Client.get_resource_metrics documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.4/reference/services/pi.html#PI.Client.get_resource_metrics)
        """
