...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-autoscaling==1.21.0",
        "aws-cdk.aws-autoscaling-hooktargets==1.21.0",
        ...
        "aws-cdk.aws-ecr==1.21.0",
        "aws-cdk.aws-ecr-assets==1.21.0",
        ...
        "aws-cdk.aws-servicediscovery==1.21.0",
