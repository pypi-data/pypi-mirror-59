...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        "jsii~=0.21.1",
        "publication>=0.0.3",
        "aws-cdk.aws-applicationautoscaling==1.21.1",
        "aws-cdk.aws-autoscaling==1.21.1",
        "aws-cdk.aws-autoscaling-hooktargets==1.21.1",
        ...
        "aws-cdk.aws-ecr-assets==1.21.1",
        "aws-cdk.aws-elasticloadbalancing==1.21.1",
        ...
        "aws-cdk.aws-servicediscovery==1.21.1",
