    ...
    def getCompanyReview(links = None):
        ...
        if links == None:
            ...
            for link in links:
                ...
                utils.printProgressBar(i, len(links), prefix = ' Links Progress:', suffix = 'Complete', length = 50)
                ...
                try:
                    ...
                    for pg in range(1, pgFinal+1, 1):
                        ...
                        utils.printProgressBar(pg, pgFinal+1, prefix = ' Person Progress:', suffix = 'Complete', length = 50)
