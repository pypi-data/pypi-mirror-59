...
#        time.sleep(0.1)
    ...
    #
    def GetQisModuleSelection(self, favouriteOnly=True , additionalOptions=[], tableHeaders=None):
        deviceList = []
        foundDevices = "1"
        foundDevices2 = "2"
        scanWait = 2
        ...
        myDeviceID = listSelection(title="Select a module",message="Select a module",selectionList=foundDevices, additionalOptions= additionalOptions, nice=True, tableHeaders=tableHeaders)
