...
class LKLogger:
    ...
    def __init__(self):
        ...
        print('start time = {}'.format(
            generate_timestamp('y-m-d h:n:s', self._start_time))
        )
    ...
    init_count = count  # 建议在单行语句使用 init_count.
    ...
    def over(self, total_count=0):
        ...
        self.log('结束运行: {}'.format(
            generate_timestamp('y-m-d h:n:s', self._end_time)
        ), h=h)
