...
def run(words, version=4, level='H', color=(100, 0, 0), background=False, picture=None, colorized=False, contrast=1.0, brightness=1.0, save_name=None, save_dir=os.getcwd()):
    ...
    try:
        ...
        ver, qr_name = theqrmodule.get_qrcode(version, level, words, color, background, tempdir)
