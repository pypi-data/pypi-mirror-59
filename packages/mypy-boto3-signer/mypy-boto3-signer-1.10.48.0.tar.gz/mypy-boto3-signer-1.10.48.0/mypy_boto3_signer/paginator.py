...
class ListSigningJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListSigningJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/signer.html#Signer.Paginator.ListSigningJobs.paginate)
        """
...
class ListSigningPlatformsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListSigningPlatforms.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/signer.html#Signer.Paginator.ListSigningPlatforms.paginate)
        """
...
class ListSigningProfilesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListSigningProfiles.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/signer.html#Signer.Paginator.ListSigningProfiles.paginate)
        """
