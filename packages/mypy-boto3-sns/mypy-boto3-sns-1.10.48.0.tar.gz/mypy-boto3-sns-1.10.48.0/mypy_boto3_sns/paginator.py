...
class ListEndpointsByPlatformApplicationPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEndpointsByPlatformApplication.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/sns.html#SNS.Paginator.ListEndpointsByPlatformApplication.paginate)
        """
...
class ListPhoneNumbersOptedOutPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListPhoneNumbersOptedOut.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/sns.html#SNS.Paginator.ListPhoneNumbersOptedOut.paginate)
        """
...
class ListPlatformApplicationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListPlatformApplications.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/sns.html#SNS.Paginator.ListPlatformApplications.paginate)
        """
...
class ListSubscriptionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListSubscriptions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/sns.html#SNS.Paginator.ListSubscriptions.paginate)
        """
...
class ListSubscriptionsByTopicPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListSubscriptionsByTopic.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/sns.html#SNS.Paginator.ListSubscriptionsByTopic.paginate)
        """
...
class ListTopicsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTopics.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/sns.html#SNS.Paginator.ListTopics.paginate)
        """
