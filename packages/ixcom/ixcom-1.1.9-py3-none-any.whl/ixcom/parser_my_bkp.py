...
class MessageSearcher:
    ...
    def publish(self, msg_bytes):
        ...
        # print("publish(msg_bytes:", msg_bytes)
...
class MessageParser:
    ...
    def parse_response(self, inBytes):
        ...
        # print("inBytes_length: ", len(inBytes))
        # print("msg_bottom_bytes: ", inBytes[(16+message.header.msgLength):])
        # print("msg_bottom:", message.bottom.from_bytes(inBytes[(message.header.msgLength-4):message.header.msgLength]))
        message.from_bytes(inBytes)
        self.publish(message)

    def parse_parameter(self, inBytes):

        # print("parse_parameter: ", inBytes)
    ...
    def parse(self, inBytes):
        ...
        # bottom = data.ProtocolBottom()
        # bottom.from_bytes(inBytes)
...
class Client(MessageParser):
    ...
    # def get_align(self):
    #     return data.ProtocolBottom().gStatus
