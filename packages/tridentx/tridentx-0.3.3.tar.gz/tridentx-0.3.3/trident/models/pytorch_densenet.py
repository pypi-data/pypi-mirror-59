...
def transition_block(reduction, name):
    ...
    items[name + '_conv']=Conv2d((3, 3), filter_rate=reduction, strides=1, use_bias=False, name=name + '_conv')
...
def DenseNet(blocks,
    ...
    densenet.add_module('denseblock1', dense_block(blocks[0], name='denseblock1'))
    densenet.add_module('transitiondown2', transition_block(0.5, name='transitiondown2'))
    densenet.add_module('denseblock2', dense_block(blocks[1], name='denseblock2'))
    densenet.add_module('transitiondown3', transition_block(0.5, name='transitiondown3'))
    densenet.add_module('denseblock3', dense_block(blocks[2], name='denseblock3'))
    densenet.add_module('transitiondown4', transition_block(0.5, name='transitiondown4'))
    densenet.add_module('denseblock4', dense_block(blocks[3], name='denseblock4'))
    ...
    densenet.name = name
    model=Model(input_shape=input_shape,output=densenet)
    model.summary()
    return model