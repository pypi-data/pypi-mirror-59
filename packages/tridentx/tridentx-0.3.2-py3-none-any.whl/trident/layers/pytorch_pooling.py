...
__all__ = ['MaxPool2d','MaxPool1d','MaxPool3d','MaxUnpool1d','MaxUnpool2d','MaxUnpool3d','AvgPool1d','AvgPool2d','AvgPool3d','GlobalAvgPool2d']
...
class _PoolNd(Layer):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True,padding_mode=PaddingMode.replicate, dilation=1, **kwargs):
...
class MaxPool1d(_PoolNd):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True,padding_mode=PaddingMode.replicate, **kwargs):
        super(MaxPool1d, self).__init__(kernel_size, strides, auto_pad, **kwargs)
...
class MaxPool2d(_PoolNd):
    ...
    .. _link:
        https://github.com/vdumoulin/conv_arithmetic/blob/master/README.md
    """
    def __init__(self, kernel_size, strides=None, auto_pad=True,padding_mode=PaddingMode.zero, **kwargs):
        super(MaxPool2d, self).__init__(kernel_size, strides , auto_pad, padding_mode,**kwargs)
...
class MaxPool3d(_PoolNd):
    ...
    .. _link:
        https://github.com/vdumoulin/conv_arithmetic/blob/master/README.md
    """  # noqa: E501
    def __init__(self, kernel_size, strides=None, auto_pad=True, **kwargs):
        super(MaxPool3d, self).__init__(kernel_size, strides, auto_pad, **kwargs)
...
class MaxUnpool1d(_PoolNd):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True,  **kwargs ):
        super(MaxUnpool1d, self).__init__(kernel_size, strides, auto_pad, **kwargs)
        self.kernel_size = _single(kernel_size)
        self.strides = _single(strides if strides is not None else kernel_size)
        self.padding = _single(self.padding)
...
class MaxUnpool2d(_PoolNd):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True):
...
class MaxUnpool3d(_PoolNd):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True, **kwargs):
        super(MaxUnpool3d, self).__init__(self, kernel_size, strides, auto_pad, **kwargs)
        self.kernel_size = _triple(kernel_size)
        self.strides = _triple(strides if strides is not None else kernel_size)
        self.padding = _triple(self.padding)
...
class AvgPool1d(_PoolNd):
    ...
    """
    def __init__(self, kernel_size, strides=None, auto_pad=True,  **kwargs ):
        super(AvgPool1d, self).__init__(kernel_size, strides, auto_pad, **kwargs)
        self.kernel_size = _single(kernel_size)
        self.strides = _single(strides if strides is not None else kernel_size)
        self.padding = _single(self.padding)
        self.ceil_mode = kwargs.get('ceil_mode',False)
...
class AvgPool2d(_PoolNd):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True, **kwargs):
        super(AvgPool2d, self).__init__( kernel_size, strides, auto_pad, **kwargs)
        self.kernel_size = _triple(kernel_size)
        self.strides = _triple(strides if strides is not None else kernel_size)
        self.padding = _triple(self.padding)
        self.ceil_mode = kwargs.get('ceil_mode',False)
    ...
    def forward(self, input):
        return F.avg_pool2d(input, self.kernel_size, self.strides,
...
class AvgPool3d(_PoolNd):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True, **kwargs):
        super(AvgPool3d, self).__init__( kernel_size, strides, auto_pad, **kwargs)
        self.kernel_size = _triple(kernel_size)
        self.strides = _triple(strides if strides is not None else kernel_size)
        self.padding = _triple(self.padding)
        self.ceil_mode = kwargs.get('ceil_mode',False)
