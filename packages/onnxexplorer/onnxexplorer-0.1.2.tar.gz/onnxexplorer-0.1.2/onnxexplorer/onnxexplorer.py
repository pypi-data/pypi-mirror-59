...
try:
    ...
    logging.error('onnxexp need onnxruntime, you need install onnxruntime first.')
    exit(0)
...
version: v0.1.0
author: Fagang Jin jinfagang19@gmail.com
...
''')
        ...
        if len(sys.argv) < 3:
            parser.print_help()
            logging.info('onnxexp need a command to run after the model file. see usage above.')
            exit(0)
