...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_cdk.aws_lambda_event_sources._jsii": [
            "aws-lambda-event-sources@1.21.1.jsii.tgz"
        ],
        "aws_cdk.aws_lambda_event_sources": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-dynamodb==1.21.1",
        "aws-cdk.aws-events==1.21.1",
        "aws-cdk.aws-iam==1.21.1",
        "aws-cdk.aws-kinesis==1.21.1",
        "aws-cdk.aws-lambda==1.21.1",
        "aws-cdk.aws-s3==1.21.1",
        "aws-cdk.aws-s3-notifications==1.21.1",
        "aws-cdk.aws-sns==1.21.1",
        "aws-cdk.aws-sns-subscriptions==1.21.1",
