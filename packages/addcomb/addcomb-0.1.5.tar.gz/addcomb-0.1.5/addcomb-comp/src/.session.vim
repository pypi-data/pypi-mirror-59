...
inoremap <Plug>TComment_ :TComment
map! <D-v> *
nnoremap  :mksession! .session.vim
nnoremap <NL> :mkview
nnoremap  :loadview
noremap  :set list!
map  :NERDTreeToggle
...
noremap ' `
nmap <expr> , repmo#LastRevKey(',')
xmap <expr> , repmo#LastRevKey(',')
omap <expr> , repmo#LastRevKey(',')
nmap <expr> ; repmo#LastKey(';')
xmap <expr> ; repmo#LastKey(';')
omap <expr> ; repmo#LastKey(';')
vnoremap < <gv
vnoremap > >gv
nnoremap <expr> F repmo#ZapKey('F')
xnoremap <expr> F repmo#ZapKey('F')
onoremap <expr> F repmo#ZapKey('F')
inoremap ˚ :m .-2==gi
nnoremap <expr> T repmo#ZapKey('T')
xnoremap <expr> T repmo#ZapKey('T')
onoremap <expr> T repmo#ZapKey('T')
...
nnoremap <expr> h repmo#SelfKey('h', 'l')
xnoremap <expr> h repmo#SelfKey('h', 'l')
onoremap <expr> h repmo#SelfKey('h', 'l')
omap ic <Plug>TComment_ic
vmap ic <Plug>TComment_ic
nmap <expr> j repmo#Key('gj', 'gk')
xmap <expr> j repmo#Key('gj', 'gk')
omap <expr> j repmo#Key('gj', 'gk')
nmap <expr> k repmo#Key('gk', 'gj')
xmap <expr> k repmo#Key('gk', 'gj')
omap <expr> k repmo#Key('gk', 'gj')
nnoremap <expr> l repmo#SelfKey('l', 'h')
xnoremap <expr> l repmo#SelfKey('l', 'h')
onoremap <expr> l repmo#SelfKey('l', 'h')
...
xnoremap <expr> t repmo#ZapKey('t')
onoremap <expr> t repmo#ZapKey('t')
noremap <Plug>(repmo-lastrevkey) l
noremap <Plug>(repmo-lastkey) h
...
nnoremap <C-Z> <Nop>
nnoremap <C-K> :loadview
nnoremap <C-J> :mkview
nnoremap <C-O> :source .session.vim
nnoremap <C-F> :mksession! .session.vim
noremap <C-M> :set list!
...
silent only
silent tabonly
cd ~/Documents/projs/addcombq/src/src
...
argglobal
%argdel
$argadd comb/chapter_a.rs
edit comb/chapter_b.rs
...
exe 'vert 1resize ' . ((&columns * 111 + 102) / 204)
exe '2resize ' . ((&lines * 26 + 29) / 58)
exe 'vert 2resize ' . ((&columns * 92 + 102) / 204)
...
silent! normal! zE
let s:l = 49 - ((21 * winheight(0) + 13) / 26)
...
wincmd w
argglobal
if bufexists("public.rs") | buffer public.rs | else | edit public.rs | endif
nnoremap <buffer> <silent> <D-r> :RustRun
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 370 - ((18 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
370
...
wincmd w
argglobal
terminal ++curwin ++cols=204 ++rows=29 
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 2306 - ((9 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2306
...
exe '3resize ' . ((&lines * 29 + 29) / 58)
tabnext 1
badd +22 comb/chapter_e.rs
badd +24 comb/chapter_a.rs
badd +15 public.rs
badd +48 lib.rs
badd +25 setlike.rs
badd +16 comb/chapter_d.rs
badd +48 fastset.rs
badd +115 exactset.rs
badd +18 comb/hfolds.rs
badd +1 ~/.vimrc
badd +148 comb/chapter_b.rs
badd +22 comb/chapter_c.rs
badd +1 comb/chapter_f
badd +37 comb/chapter_f.rs
badd +11 comb/chapter_g.rs
badd +32 comb/exacts.rs
badd +18 comb/mod.rs
