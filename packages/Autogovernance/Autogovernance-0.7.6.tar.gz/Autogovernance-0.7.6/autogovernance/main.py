...
if __name__=='__main__':
    ...
    TENANT = input("Introduzca el nombre del tenant: ")#'gts'
    USER = input("Introduzca su usuario: ") #'stratio'
    PASSWORD = input("Introduzca su contraseña: ") #'stratio'
