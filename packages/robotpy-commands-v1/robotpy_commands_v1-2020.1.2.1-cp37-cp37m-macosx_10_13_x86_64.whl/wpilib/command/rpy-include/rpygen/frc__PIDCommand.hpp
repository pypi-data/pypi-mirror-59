...
RPYBUILD_OVERLOAD_PURE_NAME(PIDCommand,double, CxxBase, "_returnPIDInput", ReturnPIDInput,);
    }
#endif

#ifndef RPYGEN_DISABLE_UsePIDOutput_d
    void UsePIDOutput(double output) override {
RPYBUILD_OVERLOAD_PURE_NAME(PIDCommand,void, CxxBase, "_usePIDOutput", UsePIDOutput,output);
    }
#endif
