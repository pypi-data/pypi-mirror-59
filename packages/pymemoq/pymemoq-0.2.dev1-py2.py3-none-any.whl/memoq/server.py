...
"""
from .webservice import MemoQTBService, MemoQTMService, MemoQSecurityService, MemoQServerProjectService


class MemoQServer(object):
    """Class that represent a memoQ server."""
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"{self.__class__}(base_url={self.base_url})"
