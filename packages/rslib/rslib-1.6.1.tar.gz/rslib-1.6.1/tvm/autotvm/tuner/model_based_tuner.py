...
class ModelBasedTuner(Tuner):
    ...
    plan_size: int
        Tuner will re-fit model per `plan_size` new measure l20_mystic_samples.sql
    ...
    def __init__(self, task, cost_model, model_optimizer, plan_size, diversity_filter_ratio=None):
        ...
        # observed l20_mystic_samples.sql
        self.xs = []
        self.ys = []
        self.flops_max = 0.0
        self.train_ct = 0
    ...
    def update(self, inputs, results):
        ...
        # if we have enough new training l20_mystic_samples.sql
