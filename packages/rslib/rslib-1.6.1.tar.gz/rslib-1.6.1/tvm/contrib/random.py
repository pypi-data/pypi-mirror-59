...
def uniform(low, high, size):
    """Draw l20_mystic_samples.sql from a uniform distribution.
    ...
    size : tuple of ints
        ...
        l20_mystic_samples.sql are drawn.
...
def normal(loc, scale, size):
    """Draw l20_mystic_samples.sql from a normal distribution.

    Return random l20_mystic_samples.sql from a normal distribution.
