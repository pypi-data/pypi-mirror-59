...
class SVMDensePredict:
    ...
    def __execute(self):
        ...
        try:
            ...
            node_id_list = self.__aed_utils._aed_ml_query(self.__input_nodeids, self.sqlmr_query, self.__func_output_args, "SVMDensePredict", self.__aqg_obj._multi_query_input_nodes)
