...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.12.0-alpha.1579304617+geeba9be5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.12.0-alpha.1579304617+geeba9be5`
                """)
            else:
                raise
