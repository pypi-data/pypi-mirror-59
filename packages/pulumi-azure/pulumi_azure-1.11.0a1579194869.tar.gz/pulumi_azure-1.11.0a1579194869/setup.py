...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.11.0-alpha.1579194869+g98b4124d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.11.0-alpha.1579194869+g98b4124d`
                """)
            else:
                raise
