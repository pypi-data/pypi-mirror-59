...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.12.0-alpha.1579299700+g25043ae5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.12.0-alpha.1579299700+g25043ae5`
                """)
            else:
                raise
