...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.10.0-alpha.1578593368+ge0fbdded'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.10.0-alpha.1578593368+ge0fbdded`
                """)
            else:
                raise
