...
def set_txt_record_zone(zone: easyzone.Zone, name: str, ttl: int, txt_record: Optional[str]) -> None:
    ...
    records: easyzone.Records = _name_obj.records('TXT', create=True, ttl=ttl)
    records._rdataset.update_ttl(ttl)
...
def zone_to_string(zone: easyzone.Zone) -> str:
    soa = zone.root.soa
