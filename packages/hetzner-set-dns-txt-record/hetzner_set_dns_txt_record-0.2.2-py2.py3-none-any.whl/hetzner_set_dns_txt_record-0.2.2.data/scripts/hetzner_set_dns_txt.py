...
parser.add_argument('--ttl', type=int, help='TTL setting', default='3600')
...
api.set_txt_record_zone(zone=_zone, name=_name, ttl=ttl, txt_record=value)
...
_complete_zone_file_after_changes = api.zone_to_string(_zone)
