...
class Panel_Code_FC(wx.Panel):
    ...
    def __init__(self, parent,hanndel):
        ...
        m_staticText21 = wx.StaticText(self, wx.ID_ANY, u"return type", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        m_staticText5 = wx.StaticText(self, wx.ID_ANY, u"cmmt", wx.DefaultPosition, wx.DefaultSize, 0)
