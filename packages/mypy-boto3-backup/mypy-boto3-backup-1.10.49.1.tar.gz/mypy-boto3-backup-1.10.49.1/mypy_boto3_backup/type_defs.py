...
Usage::
    ...
    from mypy_boto3.backup.type_defs import ClientCreateBackupPlanBackupPlanRulesLifecycleTypeDef

    data: ClientCreateBackupPlanBackupPlanRulesLifecycleTypeDef = {...}
"""
