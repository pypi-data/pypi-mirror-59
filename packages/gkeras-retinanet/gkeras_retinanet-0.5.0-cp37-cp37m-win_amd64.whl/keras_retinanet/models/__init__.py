...
def backbone(backbone_name):
    ...
    """
    if 'resnet18tiny' in backbone_name:
        from .resnet18Tiny import ResNet18TinyBackbone as b
    elif 'resnet' in backbone_name:
        from .resnet import ResNetBackbone as b
    elif 'mobilenet' in backbone_name:
        from .mobilenet import MobileNetBackbone as b
    elif 'vgg11tiny' in backbone_name:
        from .vgg11Tiny import VGG11TinyBackbone as b
    elif 'vgg11' in backbone_name:
        from .vgg11 import VGG11Backbone as b
    elif 'vgg13' in backbone_name:
        from .vgg13 import VGG13Backbone as b
