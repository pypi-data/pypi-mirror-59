...
def vgg_retinanet(num_classes, backbone='vgg16', inputs=None, modifier=None, **kwargs):
    ...
    if backbone == 'vgg16':
        ...
        plot_model(vgg, show_shapes=True, show_layer_names=True, to_file='VGG16.png')
    elif backbone == 'vgg19':
        vgg = keras.applications.VGG19(input_tensor=inputs, include_top=False, weights=None)
        plot_model(vgg, show_shapes=True, show_layer_names=True, to_file='VGG19.png')
    else:
    ...
    plot_model(r_model, show_shapes=True, show_layer_names=True, to_file='VGG16RetinaNet.png')
    return r_model
