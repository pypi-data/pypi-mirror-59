...
class MobileNetBackbone(Backbone):
    ...
    def preprocess_image(self, inputs):
        ...
        """
        return mobilenet_v2.preprocess_input(inputs)
...
def mobilenet_retinanet(num_classes, backbone='mobilenet224_1.0', inputs=None, modifier=None, **kwargs):
    ...
    backbone = mobilenet_v2.MobileNetV2(input_tensor=inputs, alpha=alpha, include_top=False, pooling="max", weights=None)
    ...
    #layer_names = ['conv_pw_5_bn', 'conv_pw_11_bn', 'conv_pw_13_bn']
    layer_names = ['block_9_depthwise_relu', 'block_11_depthwise_relu', 'block_13_depthwise_relu']
