...
import requests
from flask import Blueprint, Flask, Response, current_app, request, Request
...
class Frontegg(AuditsClientMixin):
    ...
    def init_app(self, app: Flask) -> None:
        ...
        @frontegg_blueprint.route('/<endpoint>', methods=('GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'HEAD', 'OPTIONS'))
        def proxy(endpoint):
            response = self._client.proxy_request(endpoint)
