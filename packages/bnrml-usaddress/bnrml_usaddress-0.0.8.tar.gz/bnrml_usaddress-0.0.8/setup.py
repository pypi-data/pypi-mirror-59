...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'bnrml_usaddress' / "version.py")
)
...
setup(
    name='bnrml_usaddress',
    description="Parse and normalize unstructured US address strings!",
    ...
    install_requires=[
        ...
        'click>=7.0,<8',
        'usaddress>=0.5.10,<0.6'
    ],
    entry_points="""
    [console_scripts]
    bnrml_usaddress=bnrml_usaddress.cli:cli
    """,
    ...
    url='https://github.com/patdaburu/bnrml_usaddress',
    download_url=(
        f'https://github.com/patdaburu/'
        f'bnrml_usaddress/archive/{version}.tar.gz'
    ),
    keywords=[
