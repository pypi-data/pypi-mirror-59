...
class Plot:
    ...
    def __create_figure(self):
        ...
        self.fig = figure(plot_width=1000, plot_height=400, x_axis_type='datetime')
        self.fig.xaxis.axis_label_text_font_size = "20pt"
        self.fig.yaxis.axis_label_text_font_size = "20pt"
    ...
    def __add_histogram_data(self):
        self.histogram = figure(tools="", plot_width=1000, plot_height=300)
        ...
        self.histogram.xaxis.axis_label_text_font_size = "20pt"
        self.histogram.yaxis.axis_label_text_font_size = "20pt"
            ...
            if select_linac[source_key] != 'None':
                for i in range(len(self.x)):
                    if select_linac[source_key].value == 'All' or \
                            self.data['Radiation Dev'][i] == select_linac[source_key].value or \
                            (select_linac[source_key].value == 'Eclipse' and self.data['Radiation Dev'][i] in ['TrueBeam1', 'TrueBeam2']) or \
                            (select_linac[source_key].value == 'Pinnacle' and self.data['Radiation Dev'][i] in ['UCTB_92', 'UC_M120']):
