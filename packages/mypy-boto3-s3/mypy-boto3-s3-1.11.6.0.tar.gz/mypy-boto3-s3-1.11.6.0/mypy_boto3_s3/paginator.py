...
class ListMultipartUploadsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListMultipartUploads.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Paginator.ListMultipartUploads.paginate)
        """
...
class ListObjectVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListObjectVersions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Paginator.ListObjectVersions.paginate)
        """
...
class ListObjectsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListObjects.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Paginator.ListObjects.paginate)
        """
...
class ListObjectsV2Paginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListObjectsV2.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Paginator.ListObjectsV2.paginate)
        """
...
class ListPartsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListParts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Paginator.ListParts.paginate)
        """
