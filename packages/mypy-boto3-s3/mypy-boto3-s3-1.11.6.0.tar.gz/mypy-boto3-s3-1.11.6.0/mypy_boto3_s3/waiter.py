...
class BucketExistsWaiter(Boto3Waiter):
    ...
    def wait(self, Bucket: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [BucketExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Waiter.BucketExists.wait)
        """
...
class BucketNotExistsWaiter(Boto3Waiter):
    ...
    def wait(self, Bucket: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [BucketNotExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Waiter.BucketNotExists.wait)
        """
...
class ObjectExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ObjectExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Waiter.ObjectExists.wait)
        """
...
class ObjectNotExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ObjectNotExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/s3.html#S3.Waiter.ObjectNotExists.wait)
        """
