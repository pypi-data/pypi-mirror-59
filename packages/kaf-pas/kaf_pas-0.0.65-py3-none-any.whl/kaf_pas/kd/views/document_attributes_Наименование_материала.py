...
def Document_attributes_Наименование_материала_Fetch(request):
    return JsonResponse(
        DSResponse(
            request=request,
...
@JsonResponseWithException()
def Document_attributes_Наименование_материала_Add(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_материала_Update(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_материала_Remove(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_материала_Lookup(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_материала_Info(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_материала_Copy(request):
