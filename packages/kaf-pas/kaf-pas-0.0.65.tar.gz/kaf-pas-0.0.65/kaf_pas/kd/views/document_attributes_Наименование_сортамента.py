...
def Document_attributes_Наименование_сортамента_Fetch(request):
    return JsonResponse(
        DSResponse(
            request=request,
...
@JsonResponseWithException()
def Document_attributes_Наименование_сортамента_Add(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_сортамента_Update(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_сортамента_Remove(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_сортамента_Lookup(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_сортамента_Info(request):
...
@JsonResponseWithException()
def Document_attributes_Наименование_сортамента_Copy(request):
