...
class DatasetServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.getLastExperimentByDatasetId = channel.unary_unary(
        '/com.mitdbg.modeldb.DatasetService/getLastExperimentByDatasetId',
        request_serializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.LastExperimentByDatasetId.SerializeToString,
        response_deserializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.LastExperimentByDatasetId.Response.FromString,
        )
    self.getExperimentRunByDataset = channel.unary_unary(
        '/com.mitdbg.modeldb.DatasetService/getExperimentRunByDataset',
        request_serializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.GetExperimentRunByDataset.SerializeToString,
        response_deserializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.GetExperimentRunByDataset.Response.FromString,
        )
...
def add_DatasetServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'getLastExperimentByDatasetId': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.LastExperimentByDatasetId.FromString,
          response_serializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.LastExperimentByDatasetId.Response.SerializeToString,
      ),
      'getExperimentRunByDataset': grpc.unary_unary_rpc_method_handler(
          servicer.getExperimentRunByDataset,
          request_deserializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.GetExperimentRunByDataset.FromString,
          response_serializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.GetExperimentRunByDataset.Response.SerializeToString,
      ),
  }
