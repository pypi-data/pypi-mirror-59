...
def train(data, graph=None, mode = Mode.mrf, inference = InferenceType.belief_propagation, iters = 1000, seed = 0, k = 3, in_model = None, initial_stepsize = 0.1, opt_progress_hook = 0, progress_hook = 0, opt_regularization_hook = 0, opt_proximal_hook = 0, T = 1, edge_fraction = 0.1, lam = 0, shared_states = False, optimizer = Optimizer.accelerated_proximal_gradient, zero_init=False):
