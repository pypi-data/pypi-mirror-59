...
which includes metadata for module Cisco_IOS_XR_lpts_pre_ifib_cfg
'''
...
_meta_table = {
    'LptsPunt' : _MetaInfoEnum('LptsPunt',
        ...
        '''Lpts punt''',
        {
            ...
            'cdp':'cdp',
            'lacp':'lacp',
        }, 'Cisco-IOS-XR-lpts-pre-ifib-cfg', _yang_ns.NAMESPACE_LOOKUP['Cisco-IOS-XR-lpts-pre-ifib-cfg']),
    'LptsDynamicFlowConfig' : _MetaInfoEnum('LptsDynamicFlowConfig',
        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_lpts_pre_ifib_cfg', 'LptsDynamicFlowConfig',
        '''Lpts dynamic flow config''',
        {
            'flows-config':'flows_config',
            'platform-config':'platform_config',
        }, 'Cisco-IOS-XR-lpts-pre-ifib-cfg', _yang_ns.NAMESPACE_LOOKUP['Cisco-IOS-XR-lpts-pre-ifib-cfg']),
    'LptsPreIFibPrecedenceNumber' : _MetaInfoEnum('LptsPreIFibPrecedenceNumber',
    ...
    'LptsFlow' : _MetaInfoEnum('LptsFlow',
        ...
        '''Lpts flow''',
        {
            ...
            'exr':'exr',
            'bob-ietf':'bob_ietf',
            'xipc-throt':'xipc_throt',
            'platform-limit':'platform_limit',
        }, 'Cisco-IOS-XR-lpts-pre-ifib-cfg', _yang_ns.NAMESPACE_LOOKUP['Cisco-IOS-XR-lpts-pre-ifib-cfg']),
    'Lptsafi' : _MetaInfoEnum('Lptsafi',
