...
which includes metadata for module Cisco_IOS_XR_wd_cfg
'''
    ...
    'Watchdog' : {
        'meta_info' : _MetaInfoClass('Watchdog', REFERENCE_CLASS,
            ...
            _MetaInfoClassMember('threshold-memory', REFERENCE_CLASS, 'ThresholdMemory', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_wd_cfg', 'Watchdog.ThresholdMemory',
                [], [],
                '''                Memory thresholds
                ''',
                'threshold_memory',
                'Cisco-IOS-XR-wd-cfg', False),
            _MetaInfoClassMember('threshold-memory-switchover', ATTRIBUTE, 'int', 'uint32',
                None, None,
                [('2', '4')], [],
            ...
            _MetaInfoClassMember('restart-deadlock-disable', ATTRIBUTE, 'Empty', 'empty',
                ...
                'Cisco-IOS-XR-wd-cfg', False),
            _MetaInfoClassMember('monitor-qnet-timeout', ATTRIBUTE, 'int', 'uint32',
                None, None,
                [('10', '3600')], [],
                ...
                'Cisco-IOS-XR-wd-cfg', False),
            _MetaInfoClassMember('monitor-cpuhog-timeout', ATTRIBUTE, 'int', 'uint32',
                None, None,
                [('10', '3600')], [],
                ...
                'Cisco-IOS-XR-wd-cfg', False),
            _MetaInfoClassMember('monitor-procnto-timeout', ATTRIBUTE, 'int', 'uint32',
                None, None,
                [('60', '3600')], [],
            ...
            _MetaInfoClassMember('overload-notification', ATTRIBUTE, 'Empty', 'empty',
                ...
                'Cisco-IOS-XR-wd-cfg', False),
            _MetaInfoClassMember('restart-cpuhog-disable', ATTRIBUTE, 'Empty', 'empty',
                None, None,
                [], [],
