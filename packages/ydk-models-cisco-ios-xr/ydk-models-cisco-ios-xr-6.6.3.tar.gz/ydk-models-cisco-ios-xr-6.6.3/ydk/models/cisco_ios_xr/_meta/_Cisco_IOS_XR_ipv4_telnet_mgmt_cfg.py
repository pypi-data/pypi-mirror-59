...
which includes metadata for module Cisco_IOS_XR_ipv4_telnet_mgmt_cfg
'''
...
_meta_table = {
    'Telnet.Vrfs.Vrf.Ipv4' : {
        'meta_info' : _MetaInfoClass('Telnet.Vrfs.Vrf.Ipv4', REFERENCE_CLASS,
            '''IPv4 configuration''',
            False, 
            [
            ...
            'ipv4',
            _yang_ns.NAMESPACE_LOOKUP['Cisco-IOS-XR-ipv4-telnet-mgmt-cfg'],
            'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg',
        ),
    },
    'Telnet.Vrfs.Vrf' : {
        'meta_info' : _MetaInfoClass('Telnet.Vrfs.Vrf', REFERENCE_LIST,
            ...
            _MetaInfoClassMember('ipv4', REFERENCE_CLASS, 'Ipv4', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg', 'Telnet.Vrfs.Vrf.Ipv4',
                [], [],
                '''                IPv4 configuration
                ''',
                'ipv4',
    ...
    'Telnet.Vrfs' : {
        'meta_info' : _MetaInfoClass('Telnet.Vrfs', REFERENCE_CLASS,
            '''VRF name for telnet service''',
            False, 
            [
            _MetaInfoClassMember('vrf', REFERENCE_LIST, 'Vrf', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg', 'Telnet.Vrfs.Vrf',
                [], [],
                '''                VRF name for telnet service
                ''',
                'vrf',
    ...
    'Telnet' : {
        'meta_info' : _MetaInfoClass('Telnet', REFERENCE_CLASS,
            '''Global Telnet configuration commands''',
            False, 
            [
            _MetaInfoClassMember('vrfs', REFERENCE_CLASS, 'Vrfs', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_telnet_mgmt_cfg', 'Telnet.Vrfs',
                [], [],
                '''                VRF name for telnet service
                ''',
                'vrfs',
