...
which includes metadata for module Cisco_IOS_XR_tty_vty_cfg
'''
...
_meta_table = {
    'Vty.VtyPools.VtyPool' : {
        'meta_info' : _MetaInfoClass('Vty.VtyPools.VtyPool', REFERENCE_LIST,
            '''VTY Pool''',
            False, 
            [
            ...
            _MetaInfoClassMember('first-vty', ATTRIBUTE, 'int', 'uint32',
                None, None,
                [('0', '4294967295')], [],
                ...
                ''',
                'first_vty',
                'Cisco-IOS-XR-tty-vty-cfg', False, is_mandatory=True),
            _MetaInfoClassMember('last-vty', ATTRIBUTE, 'int', 'uint32',
                None, None,
                [('0', '4294967295')], [],
                ...
                'last_vty',
                'Cisco-IOS-XR-tty-vty-cfg', False, is_mandatory=True),
            _MetaInfoClassMember('line-template', ATTRIBUTE, 'str', 'string',
                None, None,
                [], [],
            ...
            _MetaInfoClassMember('none', ATTRIBUTE, 'str', 'string',
                None, None,
                [], [],
                '''                Empty Option
                ''',
            ...
            'vty-pool',
            _yang_ns.NAMESPACE_LOOKUP['Cisco-IOS-XR-tty-vty-cfg'],
            'ydk.models.cisco_ios_xr.Cisco_IOS_XR_tty_vty_cfg',
        ),
    },
    'Vty.VtyPools' : {
        'meta_info' : _MetaInfoClass('Vty.VtyPools', REFERENCE_CLASS,
            '''List of VTY Pools''',
            False, 
            [
            _MetaInfoClassMember('vty-pool', REFERENCE_LIST, 'VtyPool', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_tty_vty_cfg', 'Vty.VtyPools.VtyPool',
                [], [],
                '''                VTY Pool
                ''',
                'vty_pool',
    ...
    'Vty' : {
        'meta_info' : _MetaInfoClass('Vty', REFERENCE_CLASS,
            '''VTY Pools configuration''',
            False, 
            [
            _MetaInfoClassMember('vty-pools', REFERENCE_CLASS, 'VtyPools', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_tty_vty_cfg', 'Vty.VtyPools',
                [], [],
                '''                List of VTY Pools
                ''',
                'vty_pools',
