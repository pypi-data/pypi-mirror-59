...
which includes metadata for module Cisco_IOS_XR_ipv4_acl_cfg
'''
...
_meta_table = {
    'NextHopType' : _MetaInfoEnum('NextHopType',
        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'NextHopType',
        '''Next-hop type.''',
        {
            'regular-next-hop':'regular_next_hop',
            'default-next-hop':'default_next_hop',
        }, 'Cisco-IOS-XR-ipv4-acl-cfg', _yang_ns.NAMESPACE_LOOKUP['Cisco-IOS-XR-ipv4-acl-cfg']),
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.SourceNetwork' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.SourceNetwork', REFERENCE_CLASS,
            ...
            _MetaInfoClassMember('source-wild-card-bits', ATTRIBUTE, 'str', 'inet:ipv4-address-no-zone',
                None, None,
                [], [b'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('source-prefix-length', ATTRIBUTE, 'int', 'xr:Ipv4-prefix-length',
                None, None,
                [('0', '32')], [],
            ...
            'source-network',
            _yang_ns.NAMESPACE_LOOKUP['Cisco-IOS-XR-ipv4-acl-cfg'],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.DestinationNetwork' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.DestinationNetwork', REFERENCE_CLASS,
            ...
            _MetaInfoClassMember('destination-address', ATTRIBUTE, 'str', 'inet:ipv4-address-no-zone',
                ...
                'destination_address',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('destination-wild-card-bits', ATTRIBUTE, 'str', 'inet:ipv4-address-no-zone',
                None, None,
                [], [b'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('destination-prefix-length', ATTRIBUTE, 'int', 'xr:Ipv4-prefix-length',
                None, None,
                [('0', '32')], [],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.SourcePort' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.SourcePort', REFERENCE_CLASS,
            '''Source port settings.''',
            False, 
            [
            _MetaInfoClassMember('source-operator', REFERENCE_ENUM_CLASS, 'Ipv4AclOperatorEnum', 'ipv4-acl-dt:Ipv4-acl-operator-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclOperatorEnum',
                [], [],
                ...
                'source_operator',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('first-source-port', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-port-number',
                None, None,
                [], [],
                ...
                'first_source_port',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('first-source-port', REFERENCE_ENUM_CLASS, 'Ipv4AclPortNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclPortNumber',
                        [], [],
                        '''                        Lower source port for comparison. It can be used
                        for the lower bound (range operator) or single value
                        (equal, less, greater..etc). Any value not in the
            ...
            _MetaInfoClassMember('second-source-port', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-port-number',
                None, None,
                [], [],
                ...
                'second_source_port',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('second-source-port', REFERENCE_ENUM_CLASS, 'Ipv4AclPortNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclPortNumber',
                        [], [],
                        '''                        Upper source port for comparion. It is used
                        in the upper bound (range operator). Any value not in the
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.DestinationPort' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.DestinationPort', REFERENCE_CLASS,
            '''Destination port settings.''',
            False, 
            [
            _MetaInfoClassMember('destination-operator', REFERENCE_ENUM_CLASS, 'Ipv4AclOperatorEnum', 'ipv4-acl-dt:Ipv4-acl-operator-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclOperatorEnum',
                [], [],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('first-destination-port', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-port-number',
                None, None,
                [], [],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('first-destination-port', REFERENCE_ENUM_CLASS, 'Ipv4AclPortNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclPortNumber',
                        [], [],
                        '''                        Lower destination port for comparison. It can be used
                        for the lower bound (range operator) or single value
            ...
            _MetaInfoClassMember('second-destination-port', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-port-number',
                None, None,
                [], [],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('second-destination-port', REFERENCE_ENUM_CLASS, 'Ipv4AclPortNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclPortNumber',
                        [], [],
                        '''                        Upper destination port for comparison. It is used
                        in the upper bound (range operator). Any value not in the
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Icmp' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Icmp', REFERENCE_CLASS,
            '''ICMP settings.''',
            False, 
            [
            _MetaInfoClassMember('icmp-type-code', REFERENCE_ENUM_CLASS, 'Ipv4AclIcmpTypeCodeEnum', 'ipv4-acl-dt:Ipv4-acl-icmp-type-code-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclIcmpTypeCodeEnum',
                [], [],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Tcp' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Tcp', REFERENCE_CLASS,
            '''TCP settings.''',
            False, 
            [
            _MetaInfoClassMember('tcp-bits-match-operator', REFERENCE_ENUM_CLASS, 'Ipv4AclTcpMatchOperatorEnum', 'ipv4-acl-dt:Ipv4-acl-tcp-match-operator-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclTcpMatchOperatorEnum',
                [], [],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('tcp-bits', REFERENCE_BITS, 'Ipv4AclTcpBitsNumber', 'ipv4-acl-dt:Ipv4-acl-tcp-bits-number',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclTcpBitsNumber',
                [], [],
                '''                TCP bits to match.
                ...
                'tcp_bits',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('tcp-bits-mask', REFERENCE_BITS, 'Ipv4AclTcpBitsNumber', 'ipv4-acl-dt:Ipv4-acl-tcp-bits-number',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclTcpBitsNumber',
                [], [],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.PacketLength' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.PacketLength', REFERENCE_CLASS,
            '''Packet length settings.''',
            False, 
            [
            _MetaInfoClassMember('packet-length-operator', REFERENCE_ENUM_CLASS, 'Ipv4AclOperatorEnum', 'ipv4-acl-dt:Ipv4-acl-operator-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclOperatorEnum',
                [], [],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('packet-length-min', ATTRIBUTE, 'int', 'ipv4-acl-dt:Ipv4-acl-plen-range',
                None, None,
                [('0', '65535')], [],
                ...
                'packet_length_min',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('packet-length-max', ATTRIBUTE, 'int', 'ipv4-acl-dt:Ipv4-acl-plen-range',
                None, None,
                [('0', '65535')], [],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.TimeToLive' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.TimeToLive', REFERENCE_CLASS,
            '''TTL settings.''',
            False, 
            [
            _MetaInfoClassMember('time-to-live-operator', REFERENCE_ENUM_CLASS, 'Ipv4AclOperatorEnum', 'ipv4-acl-dt:Ipv4-acl-operator-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclOperatorEnum',
                [], [],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('time-to-live-min', ATTRIBUTE, 'int', 'ipv4-acl-dt:Ipv4-acl-ttl-range',
                None, None,
                [('0', '255')], [],
                ...
                'time_to_live_min',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('time-to-live-max', ATTRIBUTE, 'int', 'ipv4-acl-dt:Ipv4-acl-ttl-range',
                None, None,
                [('0', '255')], [],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.FragmentOffset' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.FragmentOffset', REFERENCE_CLASS,
            '''Fragment-offset settings.''',
            False, 
            [
            _MetaInfoClassMember('fragment-offset-operator', REFERENCE_ENUM_CLASS, 'Ipv4AclOperatorEnum', 'ipv4-acl-dt:Ipv4-acl-operator-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclOperatorEnum',
                [], [],
                ...
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('fragment-offset-1', ATTRIBUTE, 'int', 'ipv4-acl-dt:Ipv4-acl-frag-offset-range',
                None, None,
                [('0', '8191')], [],
                ...
                'fragment_offset_1',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('fragment-offset-2', ATTRIBUTE, 'int', 'ipv4-acl-dt:Ipv4-acl-frag-offset-range',
                None, None,
                [('0', '8191')], [],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop1' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop1', REFERENCE_CLASS,
            '''The first next-hop settings.''',
            False, 
            [
            _MetaInfoClassMember('next-hop', ATTRIBUTE, 'str', 'inet:ipv4-address-no-zone',
                None, None,
                [], [b'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop2' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop2', REFERENCE_CLASS,
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop3' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop3', REFERENCE_CLASS,
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop', REFERENCE_CLASS,
            '''Next-hop settings.''',
            False, 
            [
            ...
            _MetaInfoClassMember('next-hop-1', REFERENCE_CLASS, 'NextHop1', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop1',
                [], [],
                '''                The first next-hop settings.
                ''',
                'next_hop_1',
            ...
            _MetaInfoClassMember('next-hop-2', REFERENCE_CLASS, 'NextHop2', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop2',
                [], [],
                '''                The second next-hop settings.
                ''',
                'next_hop_2',
            ...
            _MetaInfoClassMember('next-hop-3', REFERENCE_CLASS, 'NextHop3', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop.NextHop3',
                [], [],
                '''                The third next-hop settings.
                ''',
                'next_hop_3',
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Dscp' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Dscp', REFERENCE_CLASS,
            '''DSCP settings.''',
            False, 
            [
            _MetaInfoClassMember('dscp-operator', REFERENCE_ENUM_CLASS, 'Ipv4AclOperatorEnum', 'ipv4-acl-dt:Ipv4-acl-operator-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclOperatorEnum',
                [], [],
                ...
                'dscp_operator',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('dscp-min', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-dscp-number',
                None, None,
                [], [],
                ...
                'dscp_min',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('dscp-min', REFERENCE_ENUM_CLASS, 'Ipv4AclDscpNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclDscpNumber',
                        [], [],
                        '''                        Mininum DSCP value for comparison. It can be used for the
                        lower bound (range operator) or single value (equal, less,
                        greater..etc). Any value not in the permissible range will
                        ...
                        'dscp_min',
                        'Cisco-IOS-XR-ipv4-acl-cfg', False),
                    _MetaInfoClassMember('dscp-min', ATTRIBUTE, 'int', 'uint32',
                        None, None,
                        [('0', '63')], [],
                        '''                        Mininum DSCP value for comparison. It can be used for the
                        lower bound (range operator) or single value (equal, less,
            ...
            _MetaInfoClassMember('dscp-max', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-dscp-number',
                None, None,
                [], [],
                ...
                'dscp_max',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('dscp-max', REFERENCE_ENUM_CLASS, 'Ipv4AclDscpNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclDscpNumber',
                        [], [],
                        '''                        Maximum DSCP value for comparison. It is used in the
                        upper bound (range operator). Any value not in the
                        ...
                        'dscp_max',
                        'Cisco-IOS-XR-ipv4-acl-cfg', False),
                    _MetaInfoClassMember('dscp-max', ATTRIBUTE, 'int', 'uint32',
                        None, None,
                        [('0', '63')], [],
                        '''                        Maximum DSCP value for comparison. It is used in the
                        upper bound (range operator). Any value not in the
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry', REFERENCE_LIST,
            '''An ACL entry; either a description (remark)
or an ACE to match against''',
            False, 
            [
            _MetaInfoClassMember('sequence-number', ATTRIBUTE, 'int', 'dt1:Ipv4-acl-sequence-number-range-acl',
                None, None,
                [('1', '2147483643')], [],
            ...
            _MetaInfoClassMember('grant', REFERENCE_ENUM_CLASS, 'Ipv4AclGrantEnum', 'ipv4-acl-dt:Ipv4-acl-grant-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclGrantEnum',
                [], [],
                ...
                'grant',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('protocol-operator', REFERENCE_ENUM_CLASS, 'Ipv4AclOperatorEnum', 'ipv4-acl-dt:Ipv4-acl-operator-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclOperatorEnum',
                [], [],
                ...
                'protocol_operator',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('protocol', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-protocol-number',
                None, None,
                [], [],
                ...
                'protocol',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('protocol', REFERENCE_ENUM_CLASS, 'Ipv4AclProtocolNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclProtocolNumber',
                        [], [],
                        '''                        Protocol number to match. It can be used for the lower
                        bound (range operator) or single value (equal operator).
                        Any value not in the permissible range will be rejected.
            ...
            _MetaInfoClassMember('protocol2', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-protocol-number',
                None, None,
                [], [],
                ...
                'protocol2',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('protocol2', REFERENCE_ENUM_CLASS, 'Ipv4AclProtocolNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclProtocolNumber',
                        [], [],
                        '''                        Protocol2 to match. It is used in upper bound (range
                        operator). Any value not in the permissible range will
            ...
            _MetaInfoClassMember('source-network', REFERENCE_CLASS, 'SourceNetwork', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.SourceNetwork',
                [], [],
                '''                Source network settings.
                ''',
                'source_network',
            ...
            _MetaInfoClassMember('destination-network', REFERENCE_CLASS, 'DestinationNetwork', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.DestinationNetwork',
                [], [],
                '''                Destination network settings.
                ''',
                'destination_network',
            ...
            _MetaInfoClassMember('source-port', REFERENCE_CLASS, 'SourcePort', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.SourcePort',
                [], [],
                '''                Source port settings.
                ''',
                'source_port',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, has_when=True),
            _MetaInfoClassMember('destination-port', REFERENCE_CLASS, 'DestinationPort', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.DestinationPort',
                [], [],
                '''                Destination port settings.
                ''',
                'destination_port',
            ...
            _MetaInfoClassMember('icmp', REFERENCE_CLASS, 'Icmp', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Icmp',
                [], [],
                '''                ICMP settings.
                ''',
                'icmp',
            ...
            _MetaInfoClassMember('tcp', REFERENCE_CLASS, 'Tcp', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Tcp',
                [], [],
                '''                TCP settings.
                ''',
                'tcp',
            ...
            _MetaInfoClassMember('packet-length', REFERENCE_CLASS, 'PacketLength', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.PacketLength',
                [], [],
                '''                Packet length settings.
                ''',
                'packet_length',
            ...
            _MetaInfoClassMember('time-to-live', REFERENCE_CLASS, 'TimeToLive', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.TimeToLive',
                [], [],
                '''                TTL settings.
                ''',
                'time_to_live',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('fragment-offset', REFERENCE_CLASS, 'FragmentOffset', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.FragmentOffset',
                [], [],
                '''                Fragment-offset settings.
                ''',
                'fragment_offset',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('fragment-type', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-frag-flags',
                None, None,
                [], [],
                ...
                'fragment_type',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('fragment-type', REFERENCE_ENUM_CLASS, 'Ipv4AclFragFlags', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclFragFlags',
                        [], [],
                        '''                        Fragment flags, such as dont-fragment, is-fragment,
                        first-fragment and last-fragment.
                        ''',
                        'fragment_type',
                        'Cisco-IOS-XR-ipv4-acl-cfg', False),
                    _MetaInfoClassMember('fragment-type', ATTRIBUTE, 'int', 'uint32',
                        None, None,
                        [('1', '9')], [],
                        '''                        Fragment flags, such as dont-fragment, is-fragment,
                        first-fragment and last-fragment.
            ...
            _MetaInfoClassMember('next-hop', REFERENCE_CLASS, 'NextHop', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.NextHop',
                [], [],
                '''                Next-hop settings.
                ''',
                'next_hop',
            ...
            _MetaInfoClassMember('counter-name', ATTRIBUTE, 'str', 'string',
                ...
                'counter_name',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('igmp-message-type', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-igmp-number',
                None, None,
                [], [],
                ...
                'igmp_message_type',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('igmp-message-type', REFERENCE_ENUM_CLASS, 'Ipv4AclIgmpNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclIgmpNumber',
                        [], [],
                        '''                        IGMP message type to match. Leave unspecified if
                        no message type comparison is to be done.
                        ''',
                        'igmp_message_type',
                        'Cisco-IOS-XR-ipv4-acl-cfg', False, has_when=True),
                    _MetaInfoClassMember('igmp-message-type', ATTRIBUTE, 'int', 'uint32',
                        None, None,
                        [('0', '255')], [],
                        '''                        IGMP message type to match. Leave unspecified if
                        no message type comparison is to be done.
            ...
            _MetaInfoClassMember('dscp', REFERENCE_CLASS, 'Dscp', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry.Dscp',
                [], [],
                '''                DSCP settings.
                ''',
                'dscp',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('precedence', REFERENCE_UNION, 'str', 'ipv4-acl-dt:Ipv4-acl-precedence-number',
                None, None,
                [], [],
                ...
                'precedence',
                'Cisco-IOS-XR-ipv4-acl-cfg', False, [
                    _MetaInfoClassMember('precedence', REFERENCE_ENUM_CLASS, 'Ipv4AclPrecedenceNumber', 'enumeration',
                        'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclPrecedenceNumber',
                        [], [],
                        '''                        Precedence value to match (if a protocol was specified).
                        Any value not in the permissible range will be rejected.
                        Leave unspecified if precedence comparion is not to be
            ...
            _MetaInfoClassMember('log-option', REFERENCE_ENUM_CLASS, 'Ipv4AclLoggingEnum', 'ipv4-acl-dt:Ipv4-acl-logging-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclLoggingEnum',
                [], [],
            ...
            _MetaInfoClassMember('icmp-off', ATTRIBUTE, 'Empty', 'empty',
                ...
                'icmp_off',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('qos-group', ATTRIBUTE, 'int', 'ipv4-acl-dt:Ipv4-acl-qos-group-number',
                None, None,
                [('0', '512')], [],
                ...
                'qos_group',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('set-ttl', ATTRIBUTE, 'int', 'ipv4-acl-dt:Ipv4-acl-ttl-range',
                None, None,
                [('0', '255')], [],
    ...
    'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries', REFERENCE_CLASS,
            '''ACL entry table; contains list of ACEs''',
            False, 
            [
            _MetaInfoClassMember('access-list-entry', REFERENCE_LIST, 'AccessListEntry', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access.AccessListEntries.AccessListEntry',
                [], [],
                '''                An ACL entry; either a description (remark)
                or an ACE to match against
                ''',
    ...
    'Ipv4AclAndPrefixList.Accesses.Access' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses.Access', REFERENCE_LIST,
            '''An ACL''',
            False, 
            [
    ...
    'Ipv4AclAndPrefixList.Accesses' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Accesses', REFERENCE_CLASS,
...
kept consistent''',
            ...
            _MetaInfoClassMember('access', REFERENCE_LIST, 'Access', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses.Access',
                [], [],
                '''                An ACL
                ''',
                'access',
    ...
    'Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries.PrefixListEntry' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries.PrefixListEntry', REFERENCE_LIST,
            '''A prefix list entry; either a description
(remark) or a prefix to match against''',
            False, 
            [
            _MetaInfoClassMember('sequence-number', ATTRIBUTE, 'int', 'dt1:Ipv4-acl-sequence-number-range',
                None, None,
                [('1', '2147483646')], [],
                ...
                'sequence_number',
                'Cisco-IOS-XR-ipv4-acl-cfg', True),
            _MetaInfoClassMember('grant', REFERENCE_ENUM_CLASS, 'Ipv4AclGrantEnum', 'dt1:Ipv4-acl-grant-enum',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_datatypes', 'Ipv4AclGrantEnum',
                [], [],
            ...
            _MetaInfoClassMember('netmask', ATTRIBUTE, 'str', 'inet:ipv4-address-no-zone',
                ...
                'netmask',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('match-exact-length', ATTRIBUTE, 'Empty', 'empty',
                None, None,
                [], [],
                ...
                'match_exact_length',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('exact-prefix-length', ATTRIBUTE, 'int', 'dt1:Ipv4-acl-prefix-length-range',
                None, None,
                [('0', '32')], [],
                ...
                'exact_prefix_length',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('match-max-length', ATTRIBUTE, 'Empty', 'empty',
                None, None,
                [], [],
                ...
                'match_max_length',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('max-prefix-length', ATTRIBUTE, 'int', 'dt1:Ipv4-acl-prefix-length-range',
                None, None,
                [('0', '32')], [],
                ...
                'max_prefix_length',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('match-min-length', ATTRIBUTE, 'Empty', 'empty',
                None, None,
                [], [],
                ...
                'match_min_length',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('min-prefix-length', ATTRIBUTE, 'int', 'dt1:Ipv4-acl-prefix-length-range',
                None, None,
                [('0', '32')], [],
    ...
    'Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries', REFERENCE_CLASS,
            '''Sequence of entries forming a prefix list''',
            False, 
            [
            _MetaInfoClassMember('prefix-list-entry', REFERENCE_LIST, 'PrefixListEntry', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries.PrefixListEntry',
                [], [],
                '''                A prefix list entry; either a description
                (remark) or a prefix to match against
                ''',
    ...
    'Ipv4AclAndPrefixList.Prefixes.Prefix' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Prefixes.Prefix', REFERENCE_LIST,
            ...
            _MetaInfoClassMember('prefix-list-entries', REFERENCE_CLASS, 'PrefixListEntries', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Prefixes.Prefix.PrefixListEntries',
                [], [],
                '''                Sequence of entries forming a prefix list
                ''',
                'prefix_list_entries',
    ...
    'Ipv4AclAndPrefixList.Prefixes' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.Prefixes', REFERENCE_CLASS,
...
must be kept consistent''',
            ...
            _MetaInfoClassMember('prefix', REFERENCE_LIST, 'Prefix', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Prefixes.Prefix',
                [], [],
                '''                Name of a prefix list
                ''',
                'prefix',
    ...
    'Ipv4AclAndPrefixList.LogUpdate' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList.LogUpdate', REFERENCE_CLASS,
            '''Control access lists log updates''',
            False, 
            [
            _MetaInfoClassMember('threshold', ATTRIBUTE, 'int', 'dt1:Ipv4-acl-log-threshold-range',
                None, None,
                [('1', '2147483647')], [],
                ...
                'threshold',
                'Cisco-IOS-XR-ipv4-acl-cfg', False),
            _MetaInfoClassMember('rate', ATTRIBUTE, 'int', 'dt1:Ipv4-acl-log-rate-range',
                None, None,
                [('1', '1000')], [],
    ...
    'Ipv4AclAndPrefixList' : {
        'meta_info' : _MetaInfoClass('Ipv4AclAndPrefixList', REFERENCE_CLASS,
            ...
            _MetaInfoClassMember('accesses', REFERENCE_CLASS, 'Accesses', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Accesses',
                [], [],
                '''                Table of access lists.  Entries in this table
                and the AccessListExistenceTable table must be
                kept consistent
            ...
            _MetaInfoClassMember('prefixes', REFERENCE_CLASS, 'Prefixes', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.Prefixes',
                [], [],
                '''                Table of ACL prefix lists.  Entries in this
                table and the PrefixListExistenceTable table
                must be kept consistent
            ...
            _MetaInfoClassMember('log-update', REFERENCE_CLASS, 'LogUpdate', '',
                'ydk.models.cisco_ios_xr.Cisco_IOS_XR_ipv4_acl_cfg', 'Ipv4AclAndPrefixList.LogUpdate',
                [], [],
                '''                Control access lists log updates
                ''',
                'log_update',
