...
inline void vmath_quatToEuler(const float* quat, float* euler) {
	...
	euler[0] = atan2f(2.0f * quat[0] * quat[4] - 2.0f * quat[1] * quat[2], 1.0f - 2.0f * sqx - 2.0f * sqz);
	euler[1] = atan2f(2.0f * quat[1] * quat[4] - 2.0f * quat[0] * quat[2], 1.0f - 2.0f * sqy - 2.0f * sqz);
