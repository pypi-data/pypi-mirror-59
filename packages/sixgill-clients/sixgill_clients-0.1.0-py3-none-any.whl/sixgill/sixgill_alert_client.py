...
class SixgillAlertClient(SixgillBaseClient):
    ...
    def __init__(self, client_id, client_secret, channel_id, logger=None, bulk_size=1000):
        super(SixgillAlertClient, self).__init__(client_id, client_secret, channel_id, logger, bulk_size)
        self.digested_ids = []
