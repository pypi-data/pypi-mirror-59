...
class ListInstancesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListInstances.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/servicediscovery.html#ServiceDiscovery.Paginator.ListInstances.paginate)
        """
...
class ListNamespacesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListNamespaces.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/servicediscovery.html#ServiceDiscovery.Paginator.ListNamespaces.paginate)
        """
...
class ListOperationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListOperations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/servicediscovery.html#ServiceDiscovery.Paginator.ListOperations.paginate)
        """
...
class ListServicesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListServices.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/servicediscovery.html#ServiceDiscovery.Paginator.ListServices.paginate)
        """
