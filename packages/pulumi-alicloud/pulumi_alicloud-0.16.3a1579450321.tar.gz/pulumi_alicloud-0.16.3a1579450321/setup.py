...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v0.16.3-alpha.1579450321+gb0599b8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v0.16.3-alpha.1579450321+gb0599b8`
                """)
            else:
                raise
