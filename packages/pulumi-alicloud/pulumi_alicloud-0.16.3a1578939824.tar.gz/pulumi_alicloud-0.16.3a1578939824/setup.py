...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v0.16.3-alpha.1578939824+gf4c711d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v0.16.3-alpha.1578939824+gf4c711d`
                """)
            else:
                raise
