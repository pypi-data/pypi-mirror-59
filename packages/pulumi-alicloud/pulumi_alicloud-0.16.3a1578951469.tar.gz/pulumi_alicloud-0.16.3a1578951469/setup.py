...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v0.16.3-alpha.1578951469+gdcb6f0e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v0.16.3-alpha.1578951469+gdcb6f0e`
                """)
            else:
                raise
