...
.. module:: taxonompy.taxon
   :synopsis: Exports class BasicNcbiTaxon implementing a basic taxonomical unit
...
class BasicNcbiTaxon:
  ...
  class OtherName:
    ...
    def new_cde_name(self):
      self.cde_names.append(BasicNcbiTaxon.OtherName.Name())
  ...
  def __init__(self, isQuery=False):
    ...
    self.genetic_code = BasicNcbiTaxon.GeneticCode()
    self.mitogenetic_code = BasicNcbiTaxon.GeneticCode()
    self.aliases = []
    self.other_names = BasicNcbiTaxon.OtherName()
    self.dates = BasicNcbiTaxon.Date()
