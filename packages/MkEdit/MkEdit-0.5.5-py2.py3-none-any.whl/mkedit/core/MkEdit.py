...
class MkEdit(QWidget):
    ...
    def initToolBar(self):
        ...
        self.toolBarMenusList.append(ToolBarMenuInfo("code", "fa5s.code", callBack=self.converToCodeFormat))
    ...
    def converToCodeFormat(self):
        ...
        comboBoxDialog.initData(
            ['java', 'kotlin', 'c', 'c++', 'c#', 'javascript', 'html', 'css', 'php', 'python', 'swift', 'nodejs',
