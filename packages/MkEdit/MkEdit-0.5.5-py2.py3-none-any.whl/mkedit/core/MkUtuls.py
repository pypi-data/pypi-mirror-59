    ...
    def block_code(self, code, lang=None):
        ...
        if lang and lang == "mermaid":
            ...
            if code1.startswith('graph TD') or code1.startswith('sequenceDiagram') or code1.startswith(
                    'gantt') or code1.startswith('gitGraph') or code1.startswith('classDiagram') or code1.startswith('gantt') or code1.startswith('stateDiagram') or code1.startswith('pie'):
                mermaid = True
