...
class MkEdit(QWidget):
    ...
    def initToolBar(self):
        ...
        self.toolBarMenusList.append(
            ToolBarMenuInfo("save", "fa5s.save", shortcut="Ctrl+S", callBack=lambda: self.save()))
        ...
        self.toolBarMenusList.append(
            ToolBarMenuInfo("code", "fa5s.code", shortcut='Ctrl+Shift+C', callBack=self.converToCodeFormat))
        ...
        self.toolBarMenusList.append(
            ToolBarMenuInfo("table", "fa5s.table", shortcut="Ctrl+Shift+Z", callBack=self.insertTable))

        self.toolBarMenusList.append(ToolBarMenuInfo(separator=True))

        self.toolBarMenusList.append(ToolBarMenuInfo("link", "fa5s.link", shortcut='Ctrl+Shift+L', ))
        self.toolBarMenusList.append(ToolBarMenuInfo("images", "fa5s.images", shortcut='Ctrl+Shift+I'))
        self.toolBarMenusList.append(ToolBarMenuInfo(separator=True))

        self.toolBarMenusList.append(
            ToolBarMenuInfo("eye", "fa5s.eye", shortcut='Ctrl+Shift+P', callBack=lambda: self.showPreDialog()))
        self.toolBarMenusList.append(ToolBarMenuInfo("exchange", "fa5s.exchange-alt", shortcut='Ctrl+P',
    ...
    def refreshToolBar(self):
        ...
        for data in self.toolBarMenusList:
            if data.separator:
                ...
                if data.shortcut:
                    shortcut = QShortcut(QKeySequence(self.tr(data.shortcut)), self.parent())
