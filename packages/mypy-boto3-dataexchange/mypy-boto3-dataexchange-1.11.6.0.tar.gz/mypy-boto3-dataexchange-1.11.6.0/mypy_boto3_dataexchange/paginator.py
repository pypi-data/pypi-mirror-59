...
class ListDataSetRevisionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDataSetRevisions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/dataexchange.html#DataExchange.Paginator.ListDataSetRevisions.paginate)
        """
...
class ListDataSetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDataSets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/dataexchange.html#DataExchange.Paginator.ListDataSets.paginate)
        """
...
class ListJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/dataexchange.html#DataExchange.Paginator.ListJobs.paginate)
        """
...
class ListRevisionAssetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListRevisionAssets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/dataexchange.html#DataExchange.Paginator.ListRevisionAssets.paginate)
        """
