    ...
    def insert_or_update_to_database(self, record, orm_model):
        ...
        try:
            ...
            try:
                ...
                print(f"Old database row found: {row}")
                print(f"Comparing to current event: {instance}")
                print(f"Row in database was modified at {row.created}. Presented row has been modified at {instance.created}")
