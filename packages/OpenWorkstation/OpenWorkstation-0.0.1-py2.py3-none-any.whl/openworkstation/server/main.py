...
from workstation import robot, robot2, Robot, Robot2, instruments, containers  # NOQA
...
def get_protocol_locals():
    from workstation import robot, containers, instruments  # NOQA
    return locals()
...
def start():
    ...
    from workstation.server import log  # NOQA
