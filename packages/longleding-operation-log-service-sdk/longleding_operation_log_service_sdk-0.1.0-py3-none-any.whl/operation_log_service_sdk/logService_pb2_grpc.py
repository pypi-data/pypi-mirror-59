...
from . import logService_pb2 as logService__pb2
...
class OperationLogServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Log = channel.unary_unary(
        ...
        request_serializer=logService__pb2.OperationLogMessage.SerializeToString,
    ...
    self.GetOperationLogs = channel.unary_unary(
        ...
        request_serializer=logService__pb2.GetOperationLogsRequest.SerializeToString,
        response_deserializer=common__pb2.ResponseMessage.FromString,
        )
...
def add_OperationLogServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Log': grpc.unary_unary_rpc_method_handler(
          servicer.Log,
          request_deserializer=logService__pb2.OperationLogMessage.FromString,
      ...
      'GetOperationLogs': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=logService__pb2.GetOperationLogsRequest.FromString,
          response_serializer=common__pb2.ResponseMessage.SerializeToString,
      ),
  }
