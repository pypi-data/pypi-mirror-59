...
from . import logService_pb2, logService_pb2_grpc
...
class OperationLog:
    ...
    @classmethod
    def from_pb(cls, log_message: logService_pb2.OperationLogMessage):
...
class OperationLogServiceGRPCClient:
    ...
    def log(self, log_message: OperationLog):
        with grpc.insecure_channel(self._endpoint) as channel:
            stub = logService_pb2_grpc.OperationLogServiceStub(channel)
            ...
            log_message = logService_pb2.OperationLogMessage(**log_dict)
            response = None
            error = None
    ...
    def get_logs(self,
        ...
        with grpc.insecure_channel(self._endpoint) as channel:
            ...
            for k, v in tag_contains.items():
                tag_contains_message[k] = logService_pb2.GetOperationLogsRequest.ListOfString(value_in=v)
            request = logService_pb2.GetOperationLogsRequest(
            ...
            unpacked_msg = logService_pb2.GetOperationLogsResponse()
