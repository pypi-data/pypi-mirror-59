...
packages = \
['pdfworkshop',
 'pdfworkshop.pylovepdf.pylovepdf',
 'pdfworkshop.pylovepdf.pylovepdf.tools']

package_data = \
{'': ['*'],
 'pdfworkshop': ['pylovepdf/*', 'pylovepdf/pylovepdf.egg-info/*'],
 'pdfworkshop.pylovepdf.pylovepdf': ['samples/*']}
