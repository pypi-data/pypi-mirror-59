...
def main():
    ...
    p.add_argument("-s", help="SMTP服务的寄信人", dest='user',required=True)
    p.add_argument("-k", help="SMTP的授权码", dest='key', required=True)
    ...
    p.add_argument('-f', '--func', help="设置程序的工作方式，参数cert启动证书检测，参数url启动url有效性检测，默认参数all启用所有功能 ",
