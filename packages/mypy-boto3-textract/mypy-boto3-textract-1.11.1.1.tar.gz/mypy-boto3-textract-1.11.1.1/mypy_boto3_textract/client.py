...
class TextractClient:
    """
    [Textract.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client)
    """
    ...
    def analyze_document(
        ...
        """
        [Client.analyze_document documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client.analyze_document)
        """

    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client.can_paginate)
        """
    ...
    def detect_document_text(
        ...
        """
        [Client.detect_document_text documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client.detect_document_text)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client.generate_presigned_url)
        """
    ...
    def get_document_analysis(
        ...
        """
        [Client.get_document_analysis documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client.get_document_analysis)
        """
    ...
    def get_document_text_detection(
        ...
        """
        [Client.get_document_text_detection documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client.get_document_text_detection)
        """
    ...
    def start_document_analysis(
        ...
        """
        [Client.start_document_analysis documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client.start_document_analysis)
        """
    ...
    def start_document_text_detection(
        ...
        """
        [Client.start_document_text_detection documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.1/reference/services/textract.html#Textract.Client.start_document_text_detection)
        """
