...
class DownloadWidget(BaseWidget):
    ...
    def create_widget(self):
        ...
        self._widget_debug = Dropdown(description="Debug", options=[False, True], style=description_style)
        self._widget_debug_level = Dropdown(
            description="Debug Level", options=[1, 2, 3], style=description_style
        )
        self._widget_profile = Dropdown(description="Profile", options=[False, True], style=description_style)
        self._widget_profile_iterations = IntText(
            description="Profile Iterations", default=1000, style=description_style
        )
        self._widget_test_data = Dropdown(description="Test Data", options=[None], style=description_style)
                        ...
                        HBox(
                            [
                                VBox(
                                    [
                                    HBox(
                                        [self._widget_test_data, self._info_test_data],
                                    ...
                                    HBox(
                                        [self._widget_debug_level, self._info_debug_level],
                                        layout=Layout(align_self="flex-start"),
                                    ),  
                                    HBox(
                                    ...
                                    HBox(
                                        [self._widget_profile_iterations, self._info_profile_iterations],
                                        layout=Layout(align_self="flex-start"),
                                    ),                                                                                                              
                                    ]
                                )
