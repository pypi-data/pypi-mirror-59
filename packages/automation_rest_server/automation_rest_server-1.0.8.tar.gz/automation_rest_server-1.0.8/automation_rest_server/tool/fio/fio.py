...
from Lib.driver.utils.system import get_root_path, get_linux_nvme_devs, get_time_stamp
from Lib.tool.fio.fio_linux import Fio as LinuxFio
from Lib.driver.test_framework.performance_database import decorate_collect_real_time_bw_iops
from Lib.driver.test_framework.performance_database import decorate_collect_summary_result
from Lib.driver.test_framework.performance_database import decorate_run_benchmark
...
class Fio(LinuxFio):
    ...
    def __init__(self):
        ...
        if "windows" in system_str.lower():
            ...
            self.fio_file_path = os.path.join(self.root_path, "TestCase", "function", "fio", "config", "windows")
            self.fio_cmd = "fio"
        else:
            self.name = "linux_fio"
            self.fio_path = os.path.join(self.root_path, "Tools", "fio")
            self.fio_file_path = os.path.join(self.root_path, "TestCase", "function", "fio", "config", "linux")
            self.fio_cmd = "./fio"
    ...
    def get_new_fio_out_put_file(self, log_type="fio"):
        fio_result_folder = os.path.join(self.root_path, "result", "fio")
    ...
    def read_background_read_bw(self):
        file_path = os.path.join(self.root_path, "log", "background_read_bw.txt")
