...
from Lib.driver.utils.system import execute, Threads, ROOT_PATH


STATE_755 = stat.S_IRWXU | stat.S_IRGRP | stat.S_IXGRP | stat.S_IROTH | stat.S_IXOTH
FIO_LINUX_PATH = os.path.join(ROOT_PATH, "Tools", "fio", "fio")
...
class Fio(object):
    ...
    def run(self, jobfile=None, section=None, cmdline=True, outfile=None, **kwargs):
        self.thread = Threads(target=self.__start,
