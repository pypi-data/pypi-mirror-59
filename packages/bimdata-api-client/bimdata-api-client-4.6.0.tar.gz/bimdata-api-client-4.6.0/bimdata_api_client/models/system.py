...
class System(object):
    ...
    def __init__(self, id=None, uuid=None, name=None, object_type=None, description=None, elements=None):  # noqa: E501
    ...
    def object_type(self, object_type):
        ...
        :type: str
        """
        if object_type is not None and len(object_type) > 255:
