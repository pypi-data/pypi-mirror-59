...
class IfcExport(object):
    ...
    def __init__(self, classifications='UPDATED', zones='UPDATED', properties='UPDATED', systems='UPDATED', layers='UPDATED', materials='UPDATED', attributes='UPDATED', structure='UPDATED', uuids=None, file_name=None):  # noqa: E501
    ...
    def classifications(self, classifications):
        ...
        if classifications not in allowed_values:
            raise ValueError(
    ...
    def zones(self, zones):
        ...
        """
        allowed_values = ["ORIGINAL", "UPDATED", "NONE"]  # noqa: E501
        if zones not in allowed_values:
            raise ValueError(
    ...
    def properties(self, properties):
        ...
        """
        allowed_values = ["ORIGINAL", "UPDATED", "NONE"]  # noqa: E501
        if properties not in allowed_values:
            raise ValueError(
    ...
    def systems(self, systems):
        ...
        """
        allowed_values = ["ORIGINAL", "UPDATED", "NONE"]  # noqa: E501
        if systems not in allowed_values:
            raise ValueError(
    ...
    def layers(self, layers):
        ...
        """
        allowed_values = ["ORIGINAL", "UPDATED", "NONE"]  # noqa: E501
        if layers not in allowed_values:
            raise ValueError(
    ...
    def materials(self, materials):
        ...
        """
        allowed_values = ["ORIGINAL", "UPDATED", "NONE"]  # noqa: E501
        if materials not in allowed_values:
            raise ValueError(
