...
class LexRuntimeServiceClient:
    """
    [LexRuntimeService.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.5/reference/services/lex-runtime.html#LexRuntimeService.Client)
    """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.5/reference/services/lex-runtime.html#LexRuntimeService.Client.can_paginate)
        """
    ...
    def delete_session(
        ...
        """
        [Client.delete_session documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.5/reference/services/lex-runtime.html#LexRuntimeService.Client.delete_session)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.5/reference/services/lex-runtime.html#LexRuntimeService.Client.generate_presigned_url)
        """
    ...
    def get_session(
        ...
        """
        [Client.get_session documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.5/reference/services/lex-runtime.html#LexRuntimeService.Client.get_session)
        """
    ...
    def post_content(
        ...
        """
        [Client.post_content documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.5/reference/services/lex-runtime.html#LexRuntimeService.Client.post_content)
        """
    ...
    def post_text(
        ...
        """
        [Client.post_text documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.5/reference/services/lex-runtime.html#LexRuntimeService.Client.post_text)
        """
    ...
    def put_session(
        ...
        """
        [Client.put_session documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.5/reference/services/lex-runtime.html#LexRuntimeService.Client.put_session)
        """
