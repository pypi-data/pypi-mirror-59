...
from linky.utils.path_utils import find_base, get_path_in_base, get_paths_in_root, \
    is_path_in_base, get_first_dir, get_cat_tag, del_empty_parents, normpath
...
def _move(path, new_path, target_is_dir=False):
    ...
    try:
        new_rel_path = normpath(get_path_in_base(base_path, new_path, categories, True))
    except ValueError:
    ...
    del_empty_parents(path_in_base)
