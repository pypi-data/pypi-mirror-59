...
def quote(title,tag_line,input_file, output_file='', cord = (0.035,0.666), font_size='', caption_width='', border_width='' , logo_border='', border_color='red', text_font = '', cap_text_font = ''):
    repo_path = get_path()
