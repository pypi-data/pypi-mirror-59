...
class DescribeDBClustersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDBClusters.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.49/reference/services/docdb.html#DocDB.Paginator.DescribeDBClusters.paginate)
        """
...
class DescribeDBEngineVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDBEngineVersions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.49/reference/services/docdb.html#DocDB.Paginator.DescribeDBEngineVersions.paginate)
        """
...
class DescribeDBInstancesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDBInstances.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.49/reference/services/docdb.html#DocDB.Paginator.DescribeDBInstances.paginate)
        """
...
class DescribeDBSubnetGroupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDBSubnetGroups.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.49/reference/services/docdb.html#DocDB.Paginator.DescribeDBSubnetGroups.paginate)
        """
...
class DescribeEventsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeEvents.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.49/reference/services/docdb.html#DocDB.Paginator.DescribeEvents.paginate)
        """
...
class DescribeOrderableDBInstanceOptionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeOrderableDBInstanceOptions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.49/reference/services/docdb.html#DocDB.Paginator.DescribeOrderableDBInstanceOptions.paginate)
        """
