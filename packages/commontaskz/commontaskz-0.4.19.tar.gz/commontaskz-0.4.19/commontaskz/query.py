...
class Query(Task):
    def __init__(self, name=None, url=None, key=None, max_retries=3, retry_delay=timedelta(minutes=1), result_handler=JSONResultHandler()):
        super().__init__(max_retries, retry_delay, result_handler)
        self.name = name
        self.url = url
        self.key = key
