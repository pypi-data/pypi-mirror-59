...
if __package__:
    import seplot.dictionaries.kw_dictionaries as kd
    import seplot.dictionaries.style_dictionaries as sd
else:
    import dictionaries.kw_dictionaries as kd
    import dictionaries.style_dictionaries as sd
