    ...
    def request(self, method, url, *args, **kwargs):
        ...
        try:
            ...
            raise ValueError(
                ...
                # too large. Requests with sample data would have to be sent
                # as a 'Transfer-Encoding': Chunked and read as a stream.
                '(caused by a sample_preview_file that\'s too large).'
            ) from e
