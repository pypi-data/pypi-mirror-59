...
requirements = ['docutils<0.16,>=0.10',  # botocore requires <0.16 version, pin it here until it's fixed
                                         # https://github.com/aws/sagemaker-python-sdk/issues/1227
                'Click~=7.0', 'python-daemon~=2.2', 'boto3~=1.10', 'cached-property~=1.5']
