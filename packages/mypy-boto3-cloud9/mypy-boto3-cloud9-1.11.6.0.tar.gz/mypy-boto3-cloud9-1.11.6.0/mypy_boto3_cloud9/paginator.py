...
class DescribeEnvironmentMembershipsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeEnvironmentMemberships.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/cloud9.html#Cloud9.Paginator.DescribeEnvironmentMemberships.paginate)
        """
...
class ListEnvironmentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEnvironments.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/cloud9.html#Cloud9.Paginator.ListEnvironments.paginate)
        """
