    ...
    if event_code == "JT":
        if gender == "M":
            if age_group == "U13":
                ...
                return "500"
            elif age_group.startswith('V') and age_group >= "V80":
                return "400"
            else:  # unknown age group code, new country etc
                return "800"
        if gender == "F":
            if age_group in ["U13", "U14"]:
                ...
                return "500"
            elif age_group.startswith('V') and age_group >= "V75":
                return "400"
            else:
                return "600"
        ...
        if gender == "M":
            if age_group in ["U13", "U14"]:
                ...
                return "1.50"
            elif age_group.startswith('V') and age_group >= "V60":
                return "1.00"
            else:
                return "2.00"
