...
def FindComplexFunctions(IR):
    ...
    :return:
    """
    complex_functions = {"trend": trendFunction, "smth1": smoothFunction, "size":arrayFunction, "mean": arrayFunction, "max": arrayFunction, "min": arrayFunction, "sum":arrayFunction, "prod":arrayFunction, "stddev":arrayFunction} # This Dict links to the functions required for building new stocks
