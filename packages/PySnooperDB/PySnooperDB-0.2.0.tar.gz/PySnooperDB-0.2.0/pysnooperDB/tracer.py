...
import threading
import traceback
from .DataBaseFunc import create_table,insert_table
...
class Tracer:
    ...
    def __init__(self, output=None, watch=(), watch_explode=(), depth=1,
        ...
        create_table(Tracer.__tablename)
    ...
    def trace(self, frame, event, arg):
        ...
        for name, value_repr in local_reprs.items():
            ...
            if name not in old_local_reprs:
                insert_table(Tracer.__tablename, Tracer.__observelist, name, value_repr, source[Tracer.__line_no_past], Tracer.__line_no_past)
