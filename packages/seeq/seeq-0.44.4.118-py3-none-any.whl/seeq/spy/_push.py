...
def push(data=None, *, metadata=None, workbook=_common.DEFAULT_WORKBOOK_PATH,
    ...
    workbook_push_df = _push_workbooks(push_result_df, workbook_path, workbooks_to_push, quiet)
...
def _push_workbooks(push_result_df, workbook_path, workbooks, quiet):
    ...
    return spy.workbooks.push(workbooks, path=workbook_path, refresh=False, include_inventory=False, quiet=quiet)
