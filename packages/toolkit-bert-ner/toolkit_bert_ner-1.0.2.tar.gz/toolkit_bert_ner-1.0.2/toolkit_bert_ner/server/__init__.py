...
sys.path.append('..')
from toolkit_bert_ner.train.models import convert_id_to_label
...
class BertWorker(Process):
    ...
    def input_fn_builder(self, socks, tf):
        import sys
        sys.path.append('..')
        from toolkit_bert_ner.bert.extract_features import convert_lst_to_features
        from toolkit_bert_ner.bert.tokenization import FullTokenizer
