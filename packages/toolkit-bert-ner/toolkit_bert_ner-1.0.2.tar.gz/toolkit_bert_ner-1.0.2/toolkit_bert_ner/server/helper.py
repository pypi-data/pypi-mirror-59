...
__all__ = ['set_logger', 'send_ndarray', 'get_args_parser',
           'check_tf_version', 'auto_bind', 'import_tf', 'get_run_args']
...
def get_args_parser():
    ...
    group1.add_argument('-bert_model_dir', type=str, default=bert_path,
                        help='chinese google toolkit_bert_ner model path')
    ...
    group1.add_argument('-ckpt_name', type=str, default='bert_model.ckpt-31661',
