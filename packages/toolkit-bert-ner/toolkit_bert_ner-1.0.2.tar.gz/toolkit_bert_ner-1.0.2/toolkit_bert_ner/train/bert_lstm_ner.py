...
from toolkit_bert_ner.train import tf_metrics
from toolkit_bert_ner.bert import modeling
from toolkit_bert_ner.bert import optimization
from toolkit_bert_ner.bert import tokenization

from toolkit_bert_ner.train.models import create_model, InputFeatures, InputExample
from toolkit_bert_ner.server.helper import set_logger
__version__ = '0.1.0'
...
def train(args):
    ...
    if args.do_predict:
        ...
        from toolkit_bert_ner.train import conlleval
