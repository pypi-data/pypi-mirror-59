...
std::vector<std::vector<std::vector<double> > > Counter::count_from_vectors_single_node(std::vector<int> src_nodes, std::vector<int> dst_nodes,int V, int node){

    Graph g = Graph(src_nodes, dst_nodes, V);
    int nr_of_orbits = 15;
...
std::vector<std::vector<std::vector<double> > > Counter::count_from_vectors(std::vector<int> src_nodes, std::vector<int> dst_nodes, int V){
