...
class Message:
    ...
    def to_json(self, return_instance=False):
        ...
        Args:
            ...
            return_instance (bool): Indicates if a LIXI message instance needs to be created from the result and returned. 
    ...
    def get_message_paths(self, output_path=None):
        ...
        if output_path == None:
            ...
            self.__write__(
                "message_paths_output.txt", output_path, ",\n".join(message_paths_list)
            )
            return message_paths_list
    ...
    def get_schema_paths(self, output_path=None):
        ...
        if output_path == None:
            ...
            self.__write__(
                "schema_paths_output.txt", output_path, ",".join(schema_paths_list)
            )
            return schema_paths_list
    ...
    def validate_schematron(
        ...
        if schematron_schema_path != None:
            if os.path.exists(schematron_schema_path) == True:
                ...
                raise LIXIResouceNotFoundError(
                    "Schematron rules schema file not found at the specified path."
                )
        ...
        result, message = _schematron_functions.validate(
