...
if(caller_filepath is None):
    # Fall back to the CWD if we failed to find the filepath. This can happen
    # if the user is running this in the python interpreter directly.
    caller_filepath = os.getcwd()
starting_path = os.path.dirname(caller_filepath)
while True:
