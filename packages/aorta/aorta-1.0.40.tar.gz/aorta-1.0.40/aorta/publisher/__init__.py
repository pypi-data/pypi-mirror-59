...
class CommandPublisher(BasePublisher):
    ...
    def issue(self, name, params=None, on_settled=None, address=None,
        correlation_id=None, triggered_by=None, **kwargs):
        ...
        Args:
            ...
            **kwargs: named parameters to :meth:`publish()`.
        ...
        return self.publish(message, on_settled=on_settled, **kwargs)
...
class EventPublisher(BasePublisher):
    ...
    def observe(self, name, params=None,  observed=None, occurred=None,
        on_settled=None, address=None, correlation_id=None,
        triggered_by=None, **kwargs):
