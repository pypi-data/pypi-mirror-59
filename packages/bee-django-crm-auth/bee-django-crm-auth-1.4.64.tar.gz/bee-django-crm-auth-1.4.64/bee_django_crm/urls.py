...
urlpatterns = [
    ...
    url(r'^bargain/reward/list$', views.BargainRewardList.as_view(),
        name='bargain_reward_list'),
    url(r'^bargain/reward/detail(?P<pk>[0-9]+)$', views.BargainRewardDetail.as_view(),
        name='bargain_reward_detail'),
