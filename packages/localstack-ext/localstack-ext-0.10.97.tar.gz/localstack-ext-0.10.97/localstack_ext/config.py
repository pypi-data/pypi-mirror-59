...
if localstack_config.LAMBDA_CONTAINER_REGISTRY == localstack_constants.DEFAULT_LAMBDA_CONTAINER_REGISTRY:
    localstack_config.LAMBDA_CONTAINER_REGISTRY = 'localstack/lambda'
