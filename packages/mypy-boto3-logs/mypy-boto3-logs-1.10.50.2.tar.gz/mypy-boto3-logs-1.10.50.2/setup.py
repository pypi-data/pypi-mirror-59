...
class PostInstallCommand(install):
    def run(self):
        ...
        try:
            ...
            add_package_to_index("mypy-boto3-logs")
            print("mypy_boto3: Package mypy-boto3-logs added to index")
...
setup(
    ...
    description="Type annotations for boto3.CloudWatchLogs 1.10.50 service.",
    classifiers=[
