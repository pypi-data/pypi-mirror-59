...
class AbstractRunner(ABC):
    ...
    def __init__(self, drop_token=None, supervision_npy_file_suffix='_supervision.npy', features_saving_suffix='_features.npy', features_names_saving_suffix='_features_names.npy', returns_pkl_file_name='returns.pkl', local_root_directory='../data/', user = 'napoleon', lr=0.001):
        super().__init__()
