...
class NaPoleonDropboxConnector(object):
    ...
    def local_features_npy_ovverwrite_and_load_array(self, feature_type=None,
        ...
        res_feat = self.download(fullname=features_full_path, folder='', subfolder='', name=features_file_name, overwrite=False)
        ...
        res_feat_names = self.download(fullname=features_names_full_path, folder='', subfolder='', name=features_names_file_names, overwrite=False)
    ...
    def local_supervision_npy_overwrite_and_load_array(self, rebal=None, local_root_directory='', user='',supervision_npy_file_suffix=''):
        ...
        res_sup = self.download(fullname=local_supervision_npy_path, folder='', subfolder='', name=supervision_file_name, overwrite=False)
