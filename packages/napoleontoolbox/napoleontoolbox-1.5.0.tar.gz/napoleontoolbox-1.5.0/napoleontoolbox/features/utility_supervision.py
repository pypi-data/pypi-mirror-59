...
class AbstractAssembler(ABC):
    def __init__(self, features_pkl_file_name, returns_pkl_file_name, local_root_directory='../data/', user='napoleon',
                 supervision_npy_file_name='_supervision.npy', drop_token=None, low_bound=0.02, up_bound=0.4):
        super().__init__()
