...
def convertActivationType(activation_type):
    ...
    if activation_type is activations.ActivationsType.LEAK_0dot1SUB_0MAX6:
        return activations.GeneralRelu(leak=0.1, sub=0, maxv = 6.)
    ...
    if activation_type is activations.ActivationsType.LEAK_0SUB_0MAX0:
        return activations.GeneralRelu(leak=None, sub=0., maxv = 0.)
    if activation_type is activations.ActivationsType.LEAK_0SUB_0MAX6:
        return activations.GeneralRelu(leak=None, sub=0., maxv = 6.)
...
class SimpleRunner(AbstractRunner):
    def runTrial(self, saver, seed, sup, layers, epochs, n_past_features, n, s, feature_type, activation_type, convolution, lr_start, lr_type, low_bound, up_bound):
        ...
        activation_function = convertActivationType(activation_type)
