...
class AbstractRunner(ABC):
    ...
    def __init__(self, drop_token=None, dropbox_backup = True, supervision_npy_file_suffix='_supervision.npy', features_saving_suffix='_features.npy', features_names_saving_suffix='_features_names.npy', returns_pkl_file_name='returns.pkl', local_root_directory='../data/', user = 'napoleon', n_start = 252):
        super().__init__()
    ...
    def runTrial(self,saver, seed, sup, layers, epochs, n_past_features, n, s, whole_history, advance_feature, advance_signal,
                 normalize, activation_string, convolution, lr_start, lr_type):
        pass


class SimpleRunner(AbstractRunner):
    def runTrial(self, saver, seed, sup, layers, epochs, n_past_features, n, s, feature_type, activation_string, convolution, lr_start, lr_type):
        ...
        meArg = (
            ...
            activation_string, convolution, lr_start, lr_type)
        ...
        if convolution == 1:
            ...
            tm.set_optimizer(nn.MSELoss, torch.optim.Adam, lr=lr_start, lr_type = lr_type, betas=(0.9, 0.999), amsgrad=True)
