...
class UtilitySuperviser(AbstractAssembler):
    def computeUtility(self, s):
        ...
        self.dbx.local_npy_save_and_upload(data = result, rebal = s , local_root_directory= self.local_root_directory, user = self.user, supervision_npy_file_suffix= self.supervision_npy_file_suffix)
