...
class DescribeAccountModificationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeAccountModifications.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/workspaces.html#WorkSpaces.Paginator.DescribeAccountModifications.paginate)
        """
...
class DescribeIpGroupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeIpGroups.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/workspaces.html#WorkSpaces.Paginator.DescribeIpGroups.paginate)
        """
...
class DescribeWorkspaceBundlesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeWorkspaceBundles.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/workspaces.html#WorkSpaces.Paginator.DescribeWorkspaceBundles.paginate)
        """
...
class DescribeWorkspaceDirectoriesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeWorkspaceDirectories.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/workspaces.html#WorkSpaces.Paginator.DescribeWorkspaceDirectories.paginate)
        """
...
class DescribeWorkspaceImagesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeWorkspaceImages.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/workspaces.html#WorkSpaces.Paginator.DescribeWorkspaceImages.paginate)
        """
...
class DescribeWorkspacesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeWorkspaces.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/workspaces.html#WorkSpaces.Paginator.DescribeWorkspaces.paginate)
        """
...
class DescribeWorkspacesConnectionStatusPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeWorkspacesConnectionStatus.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/workspaces.html#WorkSpaces.Paginator.DescribeWorkspacesConnectionStatus.paginate)
        """
...
class ListAvailableManagementCidrRangesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAvailableManagementCidrRanges.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/workspaces.html#WorkSpaces.Paginator.ListAvailableManagementCidrRanges.paginate)
        """
