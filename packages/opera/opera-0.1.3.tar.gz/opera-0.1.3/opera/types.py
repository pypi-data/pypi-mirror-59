...
class Function(Base):
    ...
    def validate(cls, data):
        ...
        if name == "get_input" and not isinstance(args, list):
            print("CONVERTING {} to {}".format(args, [args]))
            args = [args]
    ...
    def eval(self, reference):
        print("EVAL FUNCTION {}".format(self))
        print("REFERENCE {}".format(type(reference)))
        print("EVAL: {}".format(self))
        print("ARGS: {}".format(self.data["arguments"]))
