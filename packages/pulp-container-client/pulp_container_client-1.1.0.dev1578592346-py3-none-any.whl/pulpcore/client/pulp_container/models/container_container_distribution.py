...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, name=None, pulp_created=None, base_path=None, pulp_href=None, content_guard=None, repository_version=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
