...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, name=None, repository_version=None, content_guard=None, repository=None, base_path=None, pulp_href=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
