...
class AnyInstanceInServiceWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [AnyInstanceInService.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/elb.html#ElasticLoadBalancing.Waiter.AnyInstanceInService.wait)
        """
...
class InstanceDeregisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [InstanceDeregistered.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/elb.html#ElasticLoadBalancing.Waiter.InstanceDeregistered.wait)
        """
...
class InstanceInServiceWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [InstanceInService.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.11.6/reference/services/elb.html#ElasticLoadBalancing.Waiter.InstanceInService.wait)
        """
