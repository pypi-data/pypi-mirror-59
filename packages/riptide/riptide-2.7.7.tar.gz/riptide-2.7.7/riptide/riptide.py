...
def contextualize(model, transcriptome = 'none', samples = 500, silent = False, exch_weight = False, prescreen = True,
    ...
    exch_weight : bool
        ...
        Default is True
    prescreen : bool
		Screen for blocked reactions initially to speed up later steps
    	Default is True
    fraction : float
    ...
    if transcriptome == 'none':
    	if silent == False: print('WARNING: No transcriptome provided. Analyzing most parsimonious state')
        transcriptome = {}
