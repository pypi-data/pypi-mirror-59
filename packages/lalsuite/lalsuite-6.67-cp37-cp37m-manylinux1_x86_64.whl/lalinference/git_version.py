...
id = "cde08c79ef17b321f7505893b6633000cd0610a9"
date = "2020-01-15 20:20:13 +0000"
branch = "None"
tag = "lalsuite-v6.67"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "cde08c79ef17b321f7505893b6633000cd0610a9":
        return
    msg = "Program id (cde08c79ef17b321f7505893b6633000cd0610a9) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
