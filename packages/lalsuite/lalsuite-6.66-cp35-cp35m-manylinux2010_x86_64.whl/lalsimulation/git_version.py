...
id = "04a60e3ac9b6ecb285cf96d1137c6a62a3d5cfde"
date = "2020-01-13 20:21:06 +0000"
branch = "None"
tag = "lalsuite-v6.66"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "04a60e3ac9b6ecb285cf96d1137c6a62a3d5cfde":
        return
    msg = "Program id (04a60e3ac9b6ecb285cf96d1137c6a62a3d5cfde) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
