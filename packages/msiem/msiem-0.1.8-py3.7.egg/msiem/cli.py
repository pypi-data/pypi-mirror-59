...
def parse_args():
 ...
 McAfee SIEM Command Line Interface
    ...
    alarm.add_argument('--events_fields', metavar="list of fields", nargs='+', help="List of fields you want to appear in the events sub tables. Overwritten by --json and --query_events", default=DEFAULT_EVENT_FIELDS_TABLE)
