...
class TransmissionProcess():
    ...
    def getOperators(self):
        ...
        for tag in root.findall('t:listeDesOuvrages/t:ouvrage', ns):
            ...
            # Correction bug email (peut se trouver dans mailObligatoire ou faxObligatoire
            email = tag.findtext('t:listeDesZones/t:zone/t:contact/t:mailObligatoire/t:courriel', '', ns)
            if email == '':
                email = tag.findtext('t:listeDesZones/t:zone/t:contact/t:faxObligatoire/t:courriel', '', ns)
