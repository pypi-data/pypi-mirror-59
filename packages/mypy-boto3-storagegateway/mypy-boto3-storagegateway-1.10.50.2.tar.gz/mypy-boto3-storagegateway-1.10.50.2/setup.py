...
class PostInstallCommand(install):
    def run(self):
        ...
        try:
            ...
            add_package_to_index("mypy-boto3-storagegateway")
            print("mypy_boto3: Package mypy-boto3-storagegateway added to index")
...
setup(
    ...
    description="Type annotations for boto3.StorageGateway 1.10.50 service.",
    classifiers=[
