...
def make_submodule_summaries(submodules, dirname=None):
    submod_block = _tab_indented_object_block(submodules)
...
def make_simplemod_header(
    ...
    if cls_props:
        prop_section = make_properties_section(cls_name, cls_props)
    else:
        prop_section = ""
    ...
    if cls_methods:
        ...
        meth_section = make_methods_section(cls_name, cls_methods, constructor)
    else:
        meth_section = ""
