...
kwargs = json.loads("""
{
    "name": "maskerade.rides3-secure-bucket",
    "version": "0.3.0",
    "description": "rides3-secure-bucket",
    "license": "ISC",
    ...
    "packages": [
        "maskerade.rides3_secure_bucket",
        "maskerade.rides3_secure_bucket._jsii"
    ],
    "package_data": {
        "maskerade.rides3_secure_bucket._jsii": [
            "rides3-secure-bucket@0.3.0.jsii.tgz"
        ],
        "maskerade.rides3_secure_bucket": [
            "py.typed"
        ]
