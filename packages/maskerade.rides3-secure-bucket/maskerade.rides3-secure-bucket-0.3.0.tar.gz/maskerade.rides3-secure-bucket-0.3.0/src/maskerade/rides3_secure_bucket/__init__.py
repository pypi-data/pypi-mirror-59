...
__jsii_assembly__ = jsii.JSIIAssembly.load("rides3-secure-bucket", "0.3.0", __name__, "rides3-secure-bucket@0.3.0.jsii.tgz")


class SecureBucket(aws_cdk.aws_s3.Bucket, metaclass=jsii.JSIIMeta, jsii_type="rides3-secure-bucket.SecureBucket"):
