...
If for any reason you want to deny writes to your remote server, you can lock your server memory as needed allowing you to avoid some critical problems ;)
