...
the __init__ to each module you want to have loggs.
...
class LogObject():
    ...
    def __init__(self, debug_bool=False, rich_debug_bool=False,
                 external=False, clean_log=False, flask=False,
        ...
        :param external: specify if the logs will be saved on an
                         external file, defaults to False
    ...
    def update_header_format(self, caller=getframeinfo(stack()[1][0])):
        ...
        :param caller: getframeinfo object to get some data, at the
                       start of the development of this function the
                       caller object does more, but at this time it's
                       pretty much useless, defaults to
                       getframeinfo(stack()[1][0])
        :type caller: getframeinfo Object, optional
        """
    ...
    def externalize_logs(self, handler):
        ...
        """
        # This will get the actual module name. Probably this will have
        # to be changed in the future. For now, it works.
        ...
        if not os.path.exists(root_dir + "/logs"):
            try:
                ...
                self.debug("Logs folder created.")
            except OSError:
                self.booleans["error_file"] = True
    ...
    def log(self, message_text, function_name, line,
            caller=getframeinfo(stack()[1][0]), level="DEBUG"):
        ...
        :param caller: getframeinfo object to get some data, at the
                       ...
                       pretty much useless, defaults to
                       getframeinfo(stack()[1][0])
        :type caller: getfrarmeinfo object, optional
        ...
        self.update_header_format(caller)
    ...
    def info(self, message_text, lineno=None, function=None):
        ...
        self.log(message_text, function, lineno, caller,
                 "INFO")
