...
class DBInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBInstanceAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/neptune.html#Neptune.Waiter.DBInstanceAvailable.wait)
        """
...
class DBInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBInstanceDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.48/reference/services/neptune.html#Neptune.Waiter.DBInstanceDeleted.wait)
        """
