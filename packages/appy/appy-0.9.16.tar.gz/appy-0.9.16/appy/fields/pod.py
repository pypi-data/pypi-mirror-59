...
class Pod(Field):
    ...
    def __init__(self, validator=None, show=('view', 'result'), page='main',
      ...
      loadWait=0, optimalColumnWidths=False, distributeColumns=None,
      script=None, pdfOptions='ExportNotes=True', tabbedCR=False, confirm=False,
      raiseOnError=False, action=None, beforeAction=None):
        ...
        # contents, set attribute "forceLoad" to True and/or define, in
        # attribute "loadWait", a number of seconds (or a method returning it,
        # accepting a template as unique parameter) to wait after having asked
        # LibreOffice to load the document and before sending hime additional
        # commands, ie, to update its table of contents or optimize tables.
    ...
    def getValue(self, obj, name=None, layout=None, template=None, format=None,
      ...
      executeAction=True):
        ...
        # Add parameter "loadWait" when relevant
        if wait: rendererParams['loadWait'] = wait
