...
def add_comment(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/comment".format(sensorID=sensorID)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/comment"
...
def bulk_cancel_sensor_downtime(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/bulk/downtime".format(sensorID=sensorID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/bulk/downtime?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def bulk_schedule_sensor_downtime(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/bulk/downtime".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/bulk/downtime"
...
def cancel_sensor_downtime(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/downtime".format(sensorID=sensorID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/downtime?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def create_sensor(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor"
...
def create_sensor_interface(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface".format(sensorID=sensorID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface"
...
def delete_sensor(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}".format(sensorID=sensorID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_sensor_comment(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/comment/{timestamp}".format(sensorID=sensorID, timestamp=timestamp)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/comment/{timestamp}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def disable_monitoring(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/monitoring/disable".format(sensorID=sensorID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/monitoring/disable"
...
def disable_monitoring_bulk(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/bulk/monitoring/disable".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/bulk/monitoring/disable"
...
def disable_sensor(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/disable".format(sensorID=sensorID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/disable"
...
def disable_sensors(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/bulk/disable".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/bulk/disable"
...
def enable_monitoring(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/monitoring/enable".format(sensorID=sensorID, daytime=daytime)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/monitoring/enable"
...
def enable_monitoring_bulk(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/bulk/monitoring/enable".format(daytime=daytime)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/bulk/monitoring/enable"
...
def enable_sensor(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/enable".format(sensorID=sensorID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/enable"
...
def enable_sensors(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/bulk/enable".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/bulk/enable"
...
def find_sensors_1(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/search"
...
def get_comment(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/comment".format(limit=limit, sensorID=sensorID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/comment?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_interface(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface/{interface}".format(sensorID=sensorID, interface=interface)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface/{interface}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_interface_1(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface/{interfaceNameOrID}".format(sensorID=sensorID, interfaceNameOrID=interfaceNameOrID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface/{interfaceNameOrID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_sensor_comments(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/comments".format(limit=limit, sensorID=sensorID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/comments?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_sensor_status(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/status".format(sensorID=sensorID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/status?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_sensor_interfaces(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface".format(limit=limit, sensorID=sensorID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_sensors_1(
    ...
    url = "https://api.mnemonic.no/sensors/v1/sensor".format(limit=limit, customerID=customerID, applicationName=applicationName, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/sensor?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def schedule_sensor_downtime(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/downtime"
...
def update_interface(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}/interface/{interface}"
...
def update_sensor(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/sensor/{sensorID}"
