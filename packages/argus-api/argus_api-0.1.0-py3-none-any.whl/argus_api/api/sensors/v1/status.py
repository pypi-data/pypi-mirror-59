...
def find_sensors(
    ...
    url = "https://api.mnemonic.no/sensors/v1/status/search".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/sensors/v1/status/search"
...
def get_sensor(
    ...
    url = "https://api.mnemonic.no/sensors/v1/status/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/status/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_sensors(
    ...
    url = "https://api.mnemonic.no/sensors/v1/status".format(limit=limit, customerID=customerID, applicationName=applicationName, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/status?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
