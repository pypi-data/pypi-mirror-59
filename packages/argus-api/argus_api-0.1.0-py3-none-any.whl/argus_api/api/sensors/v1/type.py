...
def add_sensor_type(
    ...
    url = "https://api.mnemonic.no/sensors/v1/type".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/sensors/v1/type"
...
def get_sensor_type(
    ...
    url = "https://api.mnemonic.no/sensors/v1/type/{idOrShortName}".format(idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/type/{idOrShortName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_sensor_types(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/type?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_sensor_type(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/type/{idOrShortName}"
