...
def create_location(
    ...
    url = "https://api.mnemonic.no/sensors/v1/location".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/sensors/v1/location"
...
def delete_location(
    ...
    url = "https://api.mnemonic.no/sensors/v1/location/{idOrShortName}".format(idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/location/{idOrShortName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def find_locations(
    ...
    url = "https://api.mnemonic.no/sensors/v1/location/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/location/search"
...
def list_locations(
    ...
    url = "https://api.mnemonic.no/sensors/v1/location".format(limit=limit, customerID=customerID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/sensors/v1/location?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_location(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/sensors/v1/location/{idOrShortName}"
