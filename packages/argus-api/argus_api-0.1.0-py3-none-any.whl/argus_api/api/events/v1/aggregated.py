...
def find_aggregated_event_stats(
    ...
    url = "https://api.mnemonic.no/events/v1/aggregated/stats".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/events/v1/aggregated/stats"
...
def find_aggregated_events(
    ...
    url = "https://api.mnemonic.no/events/v1/aggregated/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/events/v1/aggregated/search"
...
def list_aggregated_events(
    ...
    url = "https://api.mnemonic.no/events/v1/aggregated".format(limit=limit, customerID=customerID, signature=signature, ip=ip, startTimestamp=startTimestamp, endTimestamp=endTimestamp, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/events/v1/aggregated?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_events(
    ...
    url = "https://api.mnemonic.no/events/v1/aggregated".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/events/v1/aggregated"
...
def update_events_bulk(
    ...
    url = "https://api.mnemonic.no/events/v1/aggregated/bulk".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/events/v1/aggregated/bulk"
