...
def get_events_for_case(
    ...
    url = "https://api.mnemonic.no/events/v1/case/{caseID}".format(limit=limit, caseID=caseID, offset=offset)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/events/v1/case/{caseID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
