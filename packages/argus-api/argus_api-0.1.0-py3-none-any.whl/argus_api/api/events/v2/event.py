...
def submit_events(
    ...
    url = "https://api.mnemonic.no/events/v2/event".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/events/v2/event"
...
def submit_events_bulk(
    ...
    url = "https://api.mnemonic.no/events/v2/event/bulk".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/events/v2/event/bulk"
