...
def create(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/configurationadmin/v1/artifact"
...
def create_from_octet_stream(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}".format(groupID=groupID, artifactID=artifactID, version=version)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}"
...
def delete_unused(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact/unused".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/artifact/unused?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def download_by_g_a_v(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}/download".format(groupID=groupID, artifactID=artifactID, version=version)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}/download?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def download_by_id(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact/{id}/download".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/artifact/{id}/download?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_by_g_a_v(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}".format(groupID=groupID, artifactID=artifactID, version=version, includeData=includeData)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_by_id(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact/{id}".format(id=id, includeData=includeData)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/artifact/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact".format(limit=limit, orderBy=orderBy, search=search, offset=offset, orderDesc=orderDesc)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/artifact?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/artifact/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/artifact/search"
