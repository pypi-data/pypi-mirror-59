...
def add_comment_2(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/template/{id}/comment".format(id=id)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/configurationadmin/v1/template/{id}/comment"
...
def create_4(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/template".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/template"
...
def delete_3(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/template/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/template/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def duplicate_3(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/template/{id}/duplicate".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/template/{id}/duplicate"
...
def list_4(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/template".format(limit=limit, orderBy=orderBy, search=search, includeComments=includeComments, includeDeleted=includeDeleted, offset=offset, orderDesc=orderDesc)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/template?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def revisions_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/template/{id}/revisions".format(limit=limit, id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/template/{id}/revisions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_4(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/template/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/template/search"
...
def update_3(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/template/{id}"
