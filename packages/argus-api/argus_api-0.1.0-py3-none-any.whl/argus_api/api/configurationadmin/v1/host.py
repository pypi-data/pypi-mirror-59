...
def add_comment(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{id}/comment".format(id=id)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/configurationadmin/v1/host/{id}/comment"
...
def create_2(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/host"
...
def delete_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{id}".format(id=id, deleteInstances=deleteInstances)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/host/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def disable_monitoring(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{id}/monitoring/disable".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/host/{id}/monitoring/disable"
...
def duplicate_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{sourceID}/duplicate".format(sourceID=sourceID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/host/{sourceID}/duplicate"
...
def duplicate_2(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{hostID}/setupdefault".format(hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/host/{hostID}/setupdefault"
...
def enable_monitoring(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{id}/monitoring/enable".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/host/{id}/monitoring/enable"
...
def list_2(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host".format(limit=limit, orderBy=orderBy, search=search, includeComments=includeComments, includeDeleted=includeDeleted, offset=offset, orderDesc=orderDesc)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/host?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def schedule_monitoring(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{id}/monitoring/schedule".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/host/{id}/monitoring/schedule"
...
def search_2(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/host/search"
...
def update_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{hostID}".format(hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/host/{hostID}"
...
def view(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/host/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
