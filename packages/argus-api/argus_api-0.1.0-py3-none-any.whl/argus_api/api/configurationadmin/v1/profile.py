...
def attach(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile/{profileID}/artifacts/{artifactID}".format(profileID=profileID, artifactID=artifactID)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/configurationadmin/v1/profile/{profileID}/artifacts/{artifactID}"
...
def attach_by_name(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile/{profileName}/artifacts/{groupID}/{artifactID}/{version}".format(profileName=profileName, groupID=groupID, artifactID=artifactID, version=version)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/profile/{profileName}/artifacts/{groupID}/{artifactID}/{version}"
...
def attach_detach(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile/{profileID}/artifacts".format(profileID=profileID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/profile/{profileID}/artifacts"
...
def create_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/profile"
...
def delete(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/profile/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/profile/{profileID}/artifacts/{artifactID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach_by_artifact_by_g_a(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile/{profileName}/artifacts/{groupID}/{artifactID}".format(profileName=profileName, groupID=groupID, artifactID=artifactID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/profile/{profileName}/artifacts/{groupID}/{artifactID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach_by_name(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/profile/{profileName}/artifacts/{groupID}/{artifactID}/{version}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def duplicate(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile/{id}/duplicate/{name}".format(id=id, name=name)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/profile/{id}/duplicate/{name}"
...
def get_by_name(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile/{name}".format(name=name)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/profile/{name}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile".format(limit=limit, orderBy=orderBy, offset=offset, orderDesc=orderDesc)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/profile?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/profile/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/profile/search"
...
def update(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/profile/{id}"
