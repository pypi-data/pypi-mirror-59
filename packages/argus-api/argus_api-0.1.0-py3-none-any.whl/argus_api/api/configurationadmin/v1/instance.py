...
def add_comment_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/comment".format(id=id)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/comment"
...
def create_3(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/instance"
...
def delete_2(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/instance/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def disable_monitoring_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/monitoring/disable".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/monitoring/disable"
...
def enable_monitoring_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/monitoring/enable".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/monitoring/enable"
...
def list_3(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance".format(limit=limit, offset=offset, search=search, includeComments=includeComments, includeDeleted=includeDeleted, templateID=templateID, hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/instance?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def revisions(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/revisions".format(limit=limit, id=id, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/instance/{id}/revisions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def schedule_monitoring_1(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/monitoring/schedule".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/instance/{id}/monitoring/schedule"
...
def search_3(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/instance/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/instance/search"
...
def update_2(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/instance/{id}"
