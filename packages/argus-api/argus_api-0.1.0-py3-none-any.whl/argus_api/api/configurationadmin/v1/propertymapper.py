...
def create_property_mapper(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/configurationadmin/v1/propertymapper"
...
def delete_property_mapper(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}".format(idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_property_mapper(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}".format(includeConfig=includeConfig, idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def get_property_mapper_revision(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}/revisions/{revision}".format(includeConfig=includeConfig, idOrShortName=idOrShortName, revision=revision)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}/revisions/{revision}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_property_mapper_revisions(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}/revisions".format(limit=limit, idOrShortName=idOrShortName, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}/revisions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_property_mappers(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper".format(limit=limit, includeConfig=includeConfig, keywordMatch=keywordMatch, timestampMatch=timestampMatch, offset=offset, includeDeleted=includeDeleted, keyword=keyword, keywordField=keywordField, timestampField=timestampField, start=start, end=end, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/configurationadmin/v1/propertymapper?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def restore_property_mapper(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}/restore".format(idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def rollback_property_mapper(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}/revisions/{revision}/rollback".format(idOrShortName=idOrShortName, revision=revision)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/propertymapper/{idOrShortName}/revisions/{revision}/rollback"
...
def search_property_mappers(
    ...
    url = "https://api.mnemonic.no/configurationadmin/v1/propertymapper/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/configurationadmin/v1/propertymapper/search"
