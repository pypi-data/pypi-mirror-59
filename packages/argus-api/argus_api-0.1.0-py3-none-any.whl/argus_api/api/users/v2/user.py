...
def get_basic_user(
    ...
    url = "https://api.mnemonic.no/users/v2/user/{shortNameOrID}".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v2/user/{shortNameOrID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_user_image(
    ...
    url = "https://api.mnemonic.no/users/v2/user/{shortNameOrID}/picture".format(shortNameOrID=shortNameOrID, domain=domain, width=width, height=height, default=default)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v2/user/{shortNameOrID}/picture?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_basic_users(
    ...
    url = "https://api.mnemonic.no/users/v2/user".format(limit=limit, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v2/user?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_basic_users(
    ...
    url = "https://api.mnemonic.no/users/v2/user/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/users/v2/user/search"
