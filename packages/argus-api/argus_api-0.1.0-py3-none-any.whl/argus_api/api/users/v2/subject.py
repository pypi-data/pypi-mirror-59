...
def get_basic_subject(
    ...
    url = "https://api.mnemonic.no/users/v2/subject/{shortNameOrID}".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v2/subject/{shortNameOrID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_basic_subjects(
    ...
    url = "https://api.mnemonic.no/users/v2/subject".format(limit=limit, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v2/subject?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_basic_subjects(
    ...
    url = "https://api.mnemonic.no/users/v2/subject/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/users/v2/subject/search"
