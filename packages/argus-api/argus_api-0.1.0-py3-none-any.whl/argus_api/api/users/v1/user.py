...
def check_permission(
    ...
    url = "https://api.mnemonic.no/users/v1/user/{userId}/permission/{function}".format(userId=userId, function=function)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/user/{userId}/permission/{function}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def find_users(
    ...
    url = "https://api.mnemonic.no/users/v1/user/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/users/v1/user/search"
...
def get_functions(
    ...
    url = "https://api.mnemonic.no/users/v1/user/{userId}/functions".format(limit=limit, userId=userId, offset=offset, onlyRoles=onlyRoles, keywords=keywords)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/user/{userId}/functions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_profile(
    ...
    url = "https://api.mnemonic.no/users/v1/user/{userId}".format(userId=userId)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/user/{userId}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_user_by_username(
    ...
    url = "https://api.mnemonic.no/users/v1/user/{userName}".format(userName=userName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/user/{userName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_user_customers(
    ...
    url = "https://api.mnemonic.no/users/v1/user/{userId}/customers".format(limit=limit, keywordMatch=keywordMatch, userId=userId, offset=offset, keywords=keywords, keywordField=keywordField)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/user/{userId}/customers?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_user_profile_picture(
    ...
    url = "https://api.mnemonic.no/users/v1/user/{user}/picture".format(user=user, domain=domain, default=default)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/user/{user}/picture?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_users(
    ...
    url = "https://api.mnemonic.no/users/v1/user".format(limit=limit, subjectID=subjectID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/user?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_profile_picture_for_user_form(
    ...
    url = "https://api.mnemonic.no/users/v1/user/{userID}/picture".format(userID=userID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/users/v1/user/{userID}/picture"
...
def update_user_preferences(
    ...
    url = "https://api.mnemonic.no/users/v1/user/{user}/preferences".format(user=user, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/users/v1/user/{user}/preferences"
...
def view_user_preferences(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/user/{user}/preferences?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
