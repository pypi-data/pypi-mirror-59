...
def find_groups(
    ...
    url = "https://api.mnemonic.no/users/v1/group/search".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/users/v1/group/search"
...
def get_gropu_by_id(
    ...
    url = "https://api.mnemonic.no/users/v1/group/{groupId}".format(groupId=groupId)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/group/{groupId}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_group_by_name(
    ...
    url = "https://api.mnemonic.no/users/v1/group/{groupName}".format(groupName=groupName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/group/{groupName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_groups(
    ...
    url = "https://api.mnemonic.no/users/v1/group".format(limit=limit, subjectID=subjectID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/group?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
