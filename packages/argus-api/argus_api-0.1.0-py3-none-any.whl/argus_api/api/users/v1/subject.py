...
def find_subjects(
    ...
    url = "https://api.mnemonic.no/users/v1/subject/search".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/users/v1/subject/search"
...
def get_subject_by_id(
    ...
    url = "https://api.mnemonic.no/users/v1/subject/{subjectID}".format(subjectID=subjectID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/subject/{subjectID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_subject_by_name(
    ...
    url = "https://api.mnemonic.no/users/v1/subject/{subjectName}".format(subjectName=subjectName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/subject/{subjectName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_subjects(
    ...
    url = "https://api.mnemonic.no/users/v1/subject".format(limit=limit, subjectID=subjectID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/users/v1/subject?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
