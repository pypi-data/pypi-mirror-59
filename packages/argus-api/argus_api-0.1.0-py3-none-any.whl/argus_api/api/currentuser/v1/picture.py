...
def get_profile_picture(
    ...
    url = "https://api.mnemonic.no/currentuser/v1/picture".format(default=default)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/currentuser/v1/picture?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_profile_picture_json(
    ...
    url = "https://api.mnemonic.no/currentuser/v1/picture".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/currentuser/v1/picture"
