...
def get_current_user_groups(
    ...
    url = "https://api.mnemonic.no/currentuser/v1/groups".format(limit=limit, includeAncestors=includeAncestors, offset=offset)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/currentuser/v1/groups?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
