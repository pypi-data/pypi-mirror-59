...
def get_current_user_methods(
    ...
    url = "https://api.mnemonic.no/currentuser/v1/authmethods".format()
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/currentuser/v1/authmethods?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
