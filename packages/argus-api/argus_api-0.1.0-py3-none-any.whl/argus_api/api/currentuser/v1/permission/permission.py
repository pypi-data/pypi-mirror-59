...
def check_permission(
    ...
    url = "https://api.mnemonic.no/currentuser/v1/permission/{function}/{customerID}".format(function=function, customerID=customerID, domain=domain)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/currentuser/v1/permission/{function}/{customerID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
