...
def delete_properties(
    ...
    url = "https://api.mnemonic.no/currentuser/v1/prefs".format(key=key)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/currentuser/v1/prefs?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_property(
    ...
    url = "https://api.mnemonic.no/currentuser/v1/prefs/{propertyKey}".format(propertyKey=propertyKey)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/currentuser/v1/prefs/{propertyKey}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_properties(
    ...
    url = "https://api.mnemonic.no/currentuser/v1/prefs".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def set_properties_1(
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/currentuser/v1/prefs"
