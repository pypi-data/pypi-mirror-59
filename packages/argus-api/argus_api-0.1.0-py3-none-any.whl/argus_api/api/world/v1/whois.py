...
def lookup_who_is(
    ...
    url = "https://api.mnemonic.no/world/v1/whois".format(lookup=lookup)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/world/v1/whois?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
