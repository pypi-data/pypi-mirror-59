...
def get_time_zones(
    ...
    url = "https://api.mnemonic.no/world/v1/timezone".format(limit=limit, offset=offset, keywords=keywords)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/world/v1/timezone?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
