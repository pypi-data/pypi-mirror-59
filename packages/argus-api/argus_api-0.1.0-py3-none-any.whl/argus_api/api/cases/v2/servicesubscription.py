...
def add_customer_service_subscription(
    ...
    url = "https://api.mnemonic.no/cases/v2/servicesubscription".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/cases/v2/servicesubscription"
...
def delete_customer_service_subscription(
    ...
    url = "https://api.mnemonic.no/cases/v2/servicesubscription/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/servicesubscription/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_subscriptions(
    ...
    url = "https://api.mnemonic.no/cases/v2/servicesubscription".format(limit=limit, customerID=customerID, customer=customer, service=service, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/servicesubscription?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_customer_service_subscription(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/servicesubscription/{id}"
