...
def acknowledge_workflow(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/workflows/{workflow}/acknowledge".format(caseID=caseID, workflow=workflow)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/cases/v2/case/{caseID}/workflows/{workflow}/acknowledge"
...
def add_attachment(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/attachments".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/attachments"
...
def add_case_link(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/links/{linkToCaseID}".format(caseID=caseID, linkToCaseID=linkToCaseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/links/{linkToCaseID}"
...
def add_case_tag(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/tags".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/tags"
...
def add_case_watcher(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/watchers".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/watchers"
...
def add_comment(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/comments".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/comments"
...
def advanced_case_search(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/search"
...
def change_access_settings(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/access".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/access"
...
def clear_field(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/fields/{field}".format(caseID=caseID, field=field)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/fields/{field}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def close_case(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/close".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/close"
...
def create_case(
    ...
    url = "https://api.mnemonic.no/cases/v2/case".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case"
...
def current_user_watcher_status(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/watch".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/watch"
...
def delete_attachment(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/attachments/{attachmentID}".format(caseID=caseID, attachmentID=attachmentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/attachments/{attachmentID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_case(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_case_link(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/links/{linkID}".format(caseID=caseID, linkID=linkID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/links/{linkID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_comment(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/comments/{commentID}".format(caseID=caseID, commentID=commentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/comments/{commentID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def download_attachment(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/attachments/{attachmentID}/download".format(caseID=caseID, attachmentID=attachmentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/attachments/{attachmentID}/download?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def edit_comment(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/comments/{commentID}"
...
def get_case_comment_notifications(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/comments/{commentID}/notifications".format(caseID=caseID, commentID=commentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/comments/{commentID}/notifications?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_case_metadata_by_id(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_case_transaction(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/history/{transactionID}".format(caseID=caseID, transactionID=transactionID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/history/{transactionID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_field_policy_by_case(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/fieldpolicy".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/fieldpolicy?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_case_a_c_l(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/access".format(limit=limit, caseID=caseID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/access?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_case_attachments(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/attachments".format(limit=limit, caseID=caseID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/attachments?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_case_comments(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/comments".format(limit=limit, caseID=caseID, beforeComment=beforeComment, afterComment=afterComment, offset=offset, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/comments?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_case_history(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/history?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_case_links(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/links".format(limit=limit, caseID=caseID, offset=offset, direction=direction, type=type)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/links?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_case_tags(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/tags".format(limit=limit, caseID=caseID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/tags?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_case_watchers(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/watchers".format(limit=limit, includeExplicit=includeExplicit, includeDefault=includeDefault, caseID=caseID, offset=offset, includeDisabled=includeDisabled)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/watchers?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_fields(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/fields".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/fields?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_transaction_notifications(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/history/{transactionID}/notifications".format(caseID=caseID, transactionID=transactionID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/history/{transactionID}/notifications?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_workflows(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/workflows".format(caseID=caseID, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/workflows?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def merge_cases(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{mergeInto}/merge/{mergeFrom}".format(mergeInto=mergeInto, mergeFrom=mergeFrom)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{mergeInto}/merge/{mergeFrom}"
...
def move_case(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{id}/move".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{id}/move"
...
def publish_case(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/publish".format(caseID=caseID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/publish"
...
def remove_access(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/access/{aclEntryID}".format(caseID=caseID, aclEntryID=aclEntryID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/access/{aclEntryID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def remove_case_contact_watcher(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/watchers/contact/{contactID}".format(caseID=caseID, contactID=contactID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/watchers/contact/{contactID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def remove_case_tag_by_id(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/tags/{tagID}".format(caseID=caseID, tagID=tagID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/tags/{tagID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def remove_case_tag_by_key_value(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/tags/{tagKey}/{tagValue}".format(caseID=caseID, tagKey=tagKey, tagValue=tagValue)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/tags/{tagKey}/{tagValue}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def remove_case_watcher(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/watchers/{watcherID}".format(caseID=caseID, watcherID=watcherID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/watchers/{watcherID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def remove_current_user_watcher(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case/{caseID}/watch?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def request_workflow(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/{caseID}/workflows/{workflow}/request".format(caseID=caseID, workflow=workflow)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/workflows/{workflow}/request"
...
def search_case_statistics(
    ...
    url = "https://api.mnemonic.no/cases/v2/case/stats".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/stats"
...
def set_field(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/fields/{field}"
...
def simple_case_search(
    ...
    url = "https://api.mnemonic.no/cases/v2/case".format(limit=limit, customerID=customerID, customer=customer, service=service, status=status, type=type, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/case?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_case(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{id}"
...
def update_case_watcher(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/case/{caseID}/watchers/{watcherID}"
