...
def create_category(
    ...
    url = "https://api.mnemonic.no/cases/v2/category".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/cases/v2/category"
...
def delete_category(
    ...
    url = "https://api.mnemonic.no/cases/v2/category/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/category/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_categories(
    ...
    url = "https://api.mnemonic.no/cases/v2/category".format(limit=limit, id=id, shortName=shortName, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/category?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_categories(
    ...
    url = "https://api.mnemonic.no/cases/v2/category/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/category/search"
...
def update_category(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/category/{id}"
