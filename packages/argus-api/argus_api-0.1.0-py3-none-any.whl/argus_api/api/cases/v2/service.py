...
def bind_category(
    ...
    url = "https://api.mnemonic.no/cases/v2/service/{serviceID}/categories".format(serviceID=serviceID)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/cases/v2/service/{serviceID}/categories"
...
def create_service(
    ...
    url = "https://api.mnemonic.no/cases/v2/service".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/service"
...
def delete_service(
    ...
    url = "https://api.mnemonic.no/cases/v2/service/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/service/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_field_policy_by_service(
    ...
    url = "https://api.mnemonic.no/cases/v2/service/{service}/fieldpolicy".format(service=service, customer=customer, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/service/{service}/fieldpolicy?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_categories_1(
    ...
    url = "https://api.mnemonic.no/cases/v2/service/{id}/categories".format(limit=limit, id=id, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/service/{id}/categories?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_services(
    ...
    url = "https://api.mnemonic.no/cases/v2/service".format(limit=limit, id=id, shortName=shortName, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/service?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_services(
    ...
    url = "https://api.mnemonic.no/cases/v2/service/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/service/search"
...
def unbind_category(
    ...
    url = "https://api.mnemonic.no/cases/v2/service/{serviceID}/categories/{categoryID}".format(serviceID=serviceID, categoryID=categoryID, caseType=caseType)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/service/{serviceID}/categories/{categoryID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_service(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/service/{id}"
