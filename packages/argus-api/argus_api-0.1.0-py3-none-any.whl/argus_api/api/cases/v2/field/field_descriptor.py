...
def add_field_policy(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/policy".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/cases/v2/field/policy"
...
def add_field_to_policy(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/policy/{policy}/fields".format(policy=policy, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/field/policy/{policy}/fields"
...
def create_field_descriptor(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/descriptor".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/field/descriptor"
...
def delete_field_descriptor(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/descriptor/{field}".format(field=field, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/field/descriptor/{field}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_field_policy(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/policy/{policy}".format(policy=policy, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/field/policy/{policy}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_field_descriptors(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/descriptor".format(limit=limit, customerID=customerID, domain=domain, valueType=valueType, field=field, policy=policy, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/field/descriptor?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_field_policies(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/policy".format(limit=limit, customerID=customerID, domain=domain, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/field/policy?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_field_source_values(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/values/{field}".format(limit=limit, field=field, caseID=caseID, service=service, customer=customer, domain=domain, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/field/values/{field}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def remove_field_from_policy(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/policy/{policy}/fields/{field}".format(policy=policy, field=field, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/cases/v2/field/policy/{policy}/fields/{field}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_field_descriptors(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/descriptor/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/field/descriptor/search"
...
def search_field_policies(
    ...
    url = "https://api.mnemonic.no/cases/v2/field/policy/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/field/policy/search"
...
def update_field_descriptor(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/field/descriptor/{field}"
...
def update_field_policy(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/cases/v2/field/policy/{policy}"
