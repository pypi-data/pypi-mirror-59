...
def list_events(
    ...
    url = "https://api.mnemonic.no/notifications/v1/events".format()
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/notifications/v1/events?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
