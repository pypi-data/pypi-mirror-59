...
def add_action(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule/{id}/actions/{index}".format(id=id, index=index)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/notifications/v1/rule/{id}/actions/{index}"
...
def add_destination(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule/{id}/destinations".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/notifications/v1/rule/{id}/destinations"
...
def create(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/notifications/v1/rule"
...
def delete_action(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/notifications/v1/rule/{id}/actions/{index}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_destination(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule/{id}/destinations/{index}".format(id=id, index=index)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/notifications/v1/rule/{id}/destinations/{index}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_rule(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/notifications/v1/rule/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def duplicate_rule(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule/{id}/duplicate".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/notifications/v1/rule/{id}/duplicate"
...
def get_rule_by_name(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule/{name}".format(name=name)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/notifications/v1/rule/{name}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule".format(limit=limit, includeDeleted=includeDeleted, includeFlags=includeFlags, excludeFlags=excludeFlags, customerID=customerID, includeGlobal=includeGlobal, offset=offset, events=events)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/notifications/v1/rule?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_1(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/notifications/v1/rule/search"
...
def revisions(
    ...
    url = "https://api.mnemonic.no/notifications/v1/rule/{id}/revisions".format(limit=limit, id=id, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/notifications/v1/rule/{id}/revisions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_destination(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/notifications/v1/rule/{id}/destinations/{index}"
...
def update_rule(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/notifications/v1/rule/{id}"
