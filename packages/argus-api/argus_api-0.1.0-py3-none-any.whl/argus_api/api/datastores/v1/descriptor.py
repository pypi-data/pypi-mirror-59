...
def add_data_store_descriptor(
    ...
    url = "https://api.mnemonic.no/datastores/v1/descriptor".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/datastores/v1/descriptor"
...
def delete_data_store_descriptor(
    ...
    url = "https://api.mnemonic.no/datastores/v1/descriptor/{dataStore}".format(dataStore=dataStore)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/datastores/v1/descriptor/{dataStore}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_descriptors(
    ...
    url = "https://api.mnemonic.no/datastores/v1/descriptor/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/datastores/v1/descriptor/search"
...
def search_descriptors_simple(
    ...
    url = "https://api.mnemonic.no/datastores/v1/descriptor".format(limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/datastores/v1/descriptor?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_data_store_descriptor(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/datastores/v1/descriptor/{dataStore}"
