...
def delete_data_store_entries(
    ...
    url = "https://api.mnemonic.no/datastores/v1/store/{dataStore}".format(dataStore=dataStore, key=key, customerID=customerID)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/datastores/v1/store/{dataStore}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_entries_from_store(
    ...
    url = "https://api.mnemonic.no/datastores/v1/store/{dataStore}/search".format(dataStore=dataStore)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/datastores/v1/store/{dataStore}/search"
...
def get_entries_from_store_simplified(
    ...
    url = "https://api.mnemonic.no/datastores/v1/store/{dataStore}".format(limit=limit, dataStore=dataStore, offset=offset, customerID=customerID, key=key, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def get_single_entry(
    ...
    url = "https://api.mnemonic.no/datastores/v1/store/{dataStore}/{key}".format(dataStore=dataStore, key=key, customerID=customerID, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/datastores/v1/store/{dataStore}/{key}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def put_data_store_entries(
    ...
    url = "https://api.mnemonic.no/datastores/v1/store/{dataStore}".format(dataStore=dataStore)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/datastores/v1/store/{dataStore}"
...
def put_single_data_store_entry(
    ...
    url = "https://api.mnemonic.no/datastores/v1/store/{dataStore}/{key}/{value}".format(dataStore=dataStore, key=key, value=value, customerID=customerID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/datastores/v1/store/{dataStore}/{key}/{value}"
...
def put_single_data_store_entry_1(
    ...
    url = "https://api.mnemonic.no/datastores/v1/store/{dataStore}/{key}".format(dataStore=dataStore, key=key, customerID=customerID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/datastores/v1/store/{dataStore}/{key}"
