...
def add_customer_network(
    ...
    url = "https://api.mnemonic.no/customernetworks/v1/network".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/customernetworks/v1/network"
...
def add_customer_network_comment(
    ...
    url = "https://api.mnemonic.no/customernetworks/v1/network/{networkID}/comments".format(networkID=networkID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/customernetworks/v1/network/{networkID}/comments"
...
def bulk_add_customer_networks(
    ...
    url = "https://api.mnemonic.no/customernetworks/v1/network/bulk".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/customernetworks/v1/network/bulk"
...
def delete_customer_network(
    ...
    url = "https://api.mnemonic.no/customernetworks/v1/network/{networkID}".format(networkID=networkID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customernetworks/v1/network/{networkID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_customer_network_comment(
    ...
    url = "https://api.mnemonic.no/customernetworks/v1/network/{networkID}/comments/{commentID}".format(networkID=networkID, commentID=commentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customernetworks/v1/network/{networkID}/comments/{commentID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_customer_network_comments(
    ...
    url = "https://api.mnemonic.no/customernetworks/v1/network/{networkID}/comments".format(limit=limit, networkID=networkID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customernetworks/v1/network/{networkID}/comments?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_customer_networks(
    ...
    url = "https://api.mnemonic.no/customernetworks/v1/network".format(limit=limit, customerID=customerID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customernetworks/v1/network?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_customer_network(
    ...
    url = "https://api.mnemonic.no/customernetworks/v1/network/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/customernetworks/v1/network/search"
...
def update_customer_network(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/customernetworks/v1/network/{networkID}"
