...
def add_new_source(
    ...
    url = "https://api.mnemonic.no/reputation/v1/source".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/reputation/v1/source"
...
def delete_source(
    ...
    url = "https://api.mnemonic.no/reputation/v1/source/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/source/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def find_sources(
    ...
    url = "https://api.mnemonic.no/reputation/v1/source/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/source/search"
...
def get_source_by_alias(
    ...
    url = "https://api.mnemonic.no/reputation/v1/source/{alias}".format(alias=alias)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/source/{alias}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_sources(
    ...
    url = "https://api.mnemonic.no/reputation/v1/source".format(limit=limit, search=search, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/source?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def transition_source(
    ...
    url = "https://api.mnemonic.no/reputation/v1/source/{source}/transition".format(source=source)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/source/{source}/transition"
...
def update_source(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/source/{id}"
