...
def add_address_overrides(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/ip".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/reputation/v1/override/ip"
...
def add_domain_override(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/domain".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/override/domain"
...
def add_override_list(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/list".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/override/list"
...
def delete_address_override(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/ip/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/override/ip/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_address_overrides(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/ip".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/override/ip?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_domain_override(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/domain/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/override/domain/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_domain_overrides(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/domain".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/override/domain?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_override_list(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/list/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/override/list/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def find_address_overrides(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/ip/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/override/ip/search"
...
def find_domain_overrides(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/domain/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/override/domain/search"
...
def get_override_lists(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/list".format(limit=limit, offset=offset, keywords=keywords)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/override/list?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_overrides_for_domain(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/domain/{fqdn}".format(fqdn=fqdn)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/override/domain/{fqdn}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_overrides_for_i_p(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/ip/{ip}".format(ip=ip)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/override/ip/{ip}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_address_overrides(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/ip".format(limit=limit, list=list, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def list_domain_overrides(
    ...
    url = "https://api.mnemonic.no/reputation/v1/override/domain".format(limit=limit, list=list, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def update_override_list(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/override/list/{id}"
