...
def add_observations(
    ...
    url = "https://api.mnemonic.no/reputation/v1/observation".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/reputation/v1/observation"
...
def delete_observations(
    ...
    url = "https://api.mnemonic.no/reputation/v1/observation".format(sourceID=sourceID, sourceAlias=sourceAlias, address=address, fqdn=fqdn)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/observation?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def fetch_observations_for_domain(
    ...
    url = "https://api.mnemonic.no/reputation/v1/observation/domain/{fqdn}".format(fqdn=fqdn)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/observation/domain/{fqdn}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def fetch_observations_for_i_p(
    ...
    url = "https://api.mnemonic.no/reputation/v1/observation/ip/{ip}".format(ip=ip)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/observation/ip/{ip}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def find_address_observations(
    ...
    url = "https://api.mnemonic.no/reputation/v1/observation/ip/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/observation/ip/search"
...
def find_domain_observations(
    ...
    url = "https://api.mnemonic.no/reputation/v1/observation/domain/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/observation/domain/search"
...
def list_address_observations(
    ...
    url = "https://api.mnemonic.no/reputation/v1/observation/ip".format(limit=limit, sourceID=sourceID, minimumState=minimumState, minimumConfidence=minimumConfidence, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/observation/ip?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_domain_observations(
    ...
    url = "https://api.mnemonic.no/reputation/v1/observation/domain".format(limit=limit, sourceID=sourceID, minimumState=minimumState, minimumConfidence=minimumConfidence, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/observation/domain?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
