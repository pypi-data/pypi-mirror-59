...
def calculate_reputation_for_domain(
    ...
    url = "https://api.mnemonic.no/reputation/v1/calculated/domain/{fqdn}".format(fqdn=fqdn)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/calculated/domain/{fqdn}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def calculate_reputation_for_i_p(
    ...
    url = "https://api.mnemonic.no/reputation/v1/calculated/ip/{ip}".format(ip=ip)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/calculated/ip/{ip}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def find_address_reputation(
    ...
    url = "https://api.mnemonic.no/reputation/v1/calculated/ip/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/reputation/v1/calculated/ip/search"
...
def find_domain_reputation(
    ...
    url = "https://api.mnemonic.no/reputation/v1/calculated/domain/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/calculated/domain/search"
...
def list_address_reputation(
    ...
    url = "https://api.mnemonic.no/reputation/v1/calculated/ip".format(limit=limit, fromAddress=fromAddress, afterAddress=afterAddress, sourceID=sourceID, minimumValue=minimumValue, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/calculated/ip?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_domain_reputation(
    ...
    url = "https://api.mnemonic.no/reputation/v1/calculated/domain".format(limit=limit, fromDomain=fromDomain, afterDomain=afterDomain, sourceID=sourceID, minimumValue=minimumValue, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/calculated/domain?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
