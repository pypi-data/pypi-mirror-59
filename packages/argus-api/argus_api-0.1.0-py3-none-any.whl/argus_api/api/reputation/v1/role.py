...
def add_new_role(
    ...
    url = "https://api.mnemonic.no/reputation/v1/role".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/reputation/v1/role"
...
def delete_role(
    ...
    url = "https://api.mnemonic.no/reputation/v1/role/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/role/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_role_by_alias(
    ...
    url = "https://api.mnemonic.no/reputation/v1/role/{alias}".format(alias=alias)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/role/{alias}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_roles(
    ...
    url = "https://api.mnemonic.no/reputation/v1/role".format(limit=limit, search=search, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/reputation/v1/role?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_roles(
    ...
    url = "https://api.mnemonic.no/reputation/v1/role/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/role/search"
...
def update_role(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/reputation/v1/role/{id}"
