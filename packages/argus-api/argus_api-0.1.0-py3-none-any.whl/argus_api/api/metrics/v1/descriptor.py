...
def add_metric_descriptor(
    ...
    url = "https://api.mnemonic.no/metrics/v1/descriptor".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/metrics/v1/descriptor"
...
def delete_metric_descriptor(
    ...
    url = "https://api.mnemonic.no/metrics/v1/descriptor/{descriptor}".format(descriptor=descriptor, descriptorDomain=descriptorDomain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/metrics/v1/descriptor/{descriptor}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_metric_descriptors(
    ...
    url = "https://api.mnemonic.no/metrics/v1/descriptor".format(limit=limit, descriptorDomain=descriptorDomain, customer=customer, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/metrics/v1/descriptor?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_metric_descriptors(
    ...
    url = "https://api.mnemonic.no/metrics/v1/descriptor/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/metrics/v1/descriptor/search"
...
def update_metric_descriptor(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/metrics/v1/descriptor/{descriptor}"
