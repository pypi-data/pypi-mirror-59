...
def aggregate_metrics(
    ...
    url = "https://api.mnemonic.no/metrics/v1/metric/{descriptor}/aggregate".format(descriptor=descriptor, descriptorDomain=descriptorDomain)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/metrics/v1/metric/{descriptor}/aggregate"
...
def search_metrics(
    ...
    url = "https://api.mnemonic.no/metrics/v1/metric/{descriptor}/search".format(descriptor=descriptor, descriptorDomain=descriptorDomain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/metrics/v1/metric/{descriptor}/search"
...
def submit_metric(
    ...
    url = "https://api.mnemonic.no/metrics/v1/metric/{descriptor}".format(descriptor=descriptor, descriptorDomain=descriptorDomain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/metrics/v1/metric/{descriptor}"
