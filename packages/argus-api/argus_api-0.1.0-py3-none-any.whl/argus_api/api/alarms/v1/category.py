...
def add_category(
    ...
    url = "https://api.mnemonic.no/alarms/v1/category".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/alarms/v1/category"
...
def delete_category(
    ...
    url = "https://api.mnemonic.no/alarms/v1/category/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/alarms/v1/category/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_categories(
    ...
    url = "https://api.mnemonic.no/alarms/v1/category".format(limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/alarms/v1/category?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_categories(
    ...
    url = "https://api.mnemonic.no/alarms/v1/category/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/alarms/v1/category/search"
...
def update_category(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/alarms/v1/category/{id}"
