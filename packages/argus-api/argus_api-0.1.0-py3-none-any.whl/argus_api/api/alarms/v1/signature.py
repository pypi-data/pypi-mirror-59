...
def delete_signatures(
    ...
    url = "https://api.mnemonic.no/alarms/v1/signature".format(signature=signature)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/alarms/v1/signature?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_signatures(
    ...
    url = "https://api.mnemonic.no/alarms/v1/signature".format(keywordMatch=keywordMatch, limit=limit, keywords=keywords, keywordField=keywordField, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def search_signatures(
    ...
    url = "https://api.mnemonic.no/alarms/v1/signature/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/alarms/v1/signature/search"
