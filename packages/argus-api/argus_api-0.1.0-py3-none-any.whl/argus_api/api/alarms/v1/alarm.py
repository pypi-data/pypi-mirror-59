...
def add_alarm(
    ...
    url = "https://api.mnemonic.no/alarms/v1/alarm".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/alarms/v1/alarm"
...
def add_alarm_comment(
    ...
    url = "https://api.mnemonic.no/alarms/v1/alarm/{id}/comment".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/alarms/v1/alarm/{id}/comment"
...
def delete_alarm(
    ...
    url = "https://api.mnemonic.no/alarms/v1/alarm/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/alarms/v1/alarm/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_alarm_comment(
    ...
    url = "https://api.mnemonic.no/alarms/v1/alarm/{id}/comment/{timestamp}".format(id=id, timestamp=timestamp)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/alarms/v1/alarm/{id}/comment/{timestamp}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_alarms(
    ...
    url = "https://api.mnemonic.no/alarms/v1/alarm".format(keywordMatch=keywordMatch, limit=limit, keywords=keywords, keywordField=keywordField, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/alarms/v1/alarm?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def map_to_alarm(
    ...
    url = "https://api.mnemonic.no/alarms/v1/alarm/{id}/map".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/alarms/v1/alarm/{id}/map"
...
def search_alarms(
    ...
    url = "https://api.mnemonic.no/alarms/v1/alarm/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/alarms/v1/alarm/search"
...
def unmap(
    ...
    url = "https://api.mnemonic.no/alarms/v1/alarm/{id}/unmap".format(id=id, signature=signature)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/alarms/v1/alarm/{id}/unmap?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_alarm(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/alarms/v1/alarm/{id}"
