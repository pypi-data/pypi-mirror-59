...
def client_host_asset_scanned(
    ...
    url = "https://api.mnemonic.no/assets/v1/scan/{customerID}/client/{hostName}".format(customerID=customerID, hostName=hostName)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/assets/v1/scan/{customerID}/client/{hostName}"
...
def host_asset_bulk_scanned(
    ...
    url = "https://api.mnemonic.no/assets/v1/scan".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/scan"
...
def host_asset_scanned(
    ...
    url = "https://api.mnemonic.no/assets/v1/scan/{customerID}/{ip}".format(customerID=customerID, ip=ip)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/scan/{customerID}/{ip}"
...
def host_asset_scanned_by_id(
    ...
    url = "https://api.mnemonic.no/assets/v1/scan/{hostID}".format(hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/scan/{hostID}"
