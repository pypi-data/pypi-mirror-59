...
def add_host_asset(
    ...
    url = "https://api.mnemonic.no/assets/v1/host".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/assets/v1/host"
...
def delete_host_asset(
    ...
    url = "https://api.mnemonic.no/assets/v1/host/{id}".format(source=source, id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v1/host/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_host_asset(
    ...
    url = "https://api.mnemonic.no/assets/v1/host/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def merge_host_asset(
    ...
    url = "https://api.mnemonic.no/assets/v1/host/{mergeIntoID}/merge".format(mergeIntoID=mergeIntoID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/host/{mergeIntoID}/merge"
...
def search_host_asset_statistics(
    ...
    url = "https://api.mnemonic.no/assets/v1/host/statistics".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/host/statistics"
...
def search_host_assets(
    ...
    url = "https://api.mnemonic.no/assets/v1/host/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/host/search"
...
def search_host_assets_simplified(
    ...
    url = "https://api.mnemonic.no/assets/v1/host".format(limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, name=name, hostID=hostID, serviceID=serviceID, businessProcessID=businessProcessID, customerID=customerID, ip=ip, port=port, protocol=protocol, cpe=cpe, vulnID=vulnID, vulnRef=vulnRef, includeFlag=includeFlag, excludeFlag=excludeFlag, sortBy=sortBy, countTimeout=countTimeout)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v1/host?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_host_asset(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/host/{id}"
