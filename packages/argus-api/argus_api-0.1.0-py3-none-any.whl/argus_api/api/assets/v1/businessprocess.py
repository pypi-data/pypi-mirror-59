...
def add_business_process(
    ...
    url = "https://api.mnemonic.no/assets/v1/businessprocess".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/assets/v1/businessprocess"
...
def attach_services_to_business_process(
    ...
    url = "https://api.mnemonic.no/assets/v1/businessprocess/{id}/attachservices".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/businessprocess/{id}/attachservices"
...
def delete_business_process(
    ...
    url = "https://api.mnemonic.no/assets/v1/businessprocess/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v1/businessprocess/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach_services_from_business_process(
    ...
    url = "https://api.mnemonic.no/assets/v1/businessprocess/{id}/detachservices".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/businessprocess/{id}/detachservices"
...
def search_business_process_statistics(
    ...
    url = "https://api.mnemonic.no/assets/v1/businessprocess/statistics".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/businessprocess/statistics"
...
def search_business_processes(
    ...
    url = "https://api.mnemonic.no/assets/v1/businessprocess/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/businessprocess/search"
...
def search_business_processes_simplified(
    ...
    url = "https://api.mnemonic.no/assets/v1/businessprocess".format(limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, name=name, hostID=hostID, serviceID=serviceID, businessProcessID=businessProcessID, customerID=customerID, ip=ip, port=port, protocol=protocol, cpe=cpe, vulnID=vulnID, vulnRef=vulnRef, includeFlag=includeFlag, excludeFlag=excludeFlag, sortBy=sortBy, countTimeout=countTimeout)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v1/businessprocess?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_business_process(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/businessprocess/{id}"
