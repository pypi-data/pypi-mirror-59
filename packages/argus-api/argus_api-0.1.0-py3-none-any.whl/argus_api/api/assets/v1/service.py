...
def add_service_asset(
    ...
    url = "https://api.mnemonic.no/assets/v1/service".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/assets/v1/service"
...
def attach_hosts_to_service(
    ...
    url = "https://api.mnemonic.no/assets/v1/service/{id}/attachhosts".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/service/{id}/attachhosts"
...
def delete_service_asset(
    ...
    url = "https://api.mnemonic.no/assets/v1/service/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v1/service/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach_hosts_from_service(
    ...
    url = "https://api.mnemonic.no/assets/v1/service/{id}/detachhosts".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/service/{id}/detachhosts"
...
def search_service_asset_statistics(
    ...
    url = "https://api.mnemonic.no/assets/v1/service/statistics".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/service/statistics"
...
def search_service_assets(
    ...
    url = "https://api.mnemonic.no/assets/v1/service/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/service/search"
...
def search_service_assets_simplified(
    ...
    url = "https://api.mnemonic.no/assets/v1/service".format(limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, name=name, hostID=hostID, serviceID=serviceID, businessProcessID=businessProcessID, customerID=customerID, ip=ip, port=port, protocol=protocol, cpe=cpe, vulnID=vulnID, vulnRef=vulnRef, includeFlag=includeFlag, excludeFlag=excludeFlag, sortBy=sortBy, countTimeout=countTimeout)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v1/service?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_service_asset(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/service/{id}"
