...
def add_host_application(
    ...
    url = "https://api.mnemonic.no/assets/v1/application".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/assets/v1/application"
...
def delete_host_application(
    ...
    url = "https://api.mnemonic.no/assets/v1/application/{id}".format(source=source, id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v1/application/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_host_application(
    ...
    url = "https://api.mnemonic.no/assets/v1/application/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def search_host_application_statistics(
    ...
    url = "https://api.mnemonic.no/assets/v1/application/statistics".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/application/statistics"
...
def search_host_applications(
    ...
    url = "https://api.mnemonic.no/assets/v1/application/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/application/search"
...
def search_host_applications_simplified(
    ...
    url = "https://api.mnemonic.no/assets/v1/application".format(limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, name=name, hostID=hostID, serviceID=serviceID, businessProcessID=businessProcessID, customerID=customerID, ip=ip, port=port, protocol=protocol, cpe=cpe, includeFlag=includeFlag, excludeFlag=excludeFlag, sortBy=sortBy, countTimeout=countTimeout)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v1/application?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_host_application(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v1/application/{id}"
