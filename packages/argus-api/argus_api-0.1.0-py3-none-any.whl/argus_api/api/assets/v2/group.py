...
def add_asset_group(
    ...
    url = "https://api.mnemonic.no/assets/v2/group".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/assets/v2/group"
...
def attach_assets(
    ...
    url = "https://api.mnemonic.no/assets/v2/group/{idOrShortName}/assets".format(idOrShortName=idOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/group/{idOrShortName}/assets"
...
def attach_children_groups(
    ...
    url = "https://api.mnemonic.no/assets/v2/group/{idOrShortName}/groups".format(idOrShortName=idOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/group/{idOrShortName}/groups"
...
def delete_asset_group(
    ...
    url = "https://api.mnemonic.no/assets/v2/group/{idOrShortName}".format(idOrShortName=idOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/group/{idOrShortName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach_assets(
    ...
    url = "https://api.mnemonic.no/assets/v2/group/{idOrShortName}/assets".format(idOrShortName=idOrShortName, asset=asset, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/group/{idOrShortName}/assets?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach_children_groups(
    ...
    url = "https://api.mnemonic.no/assets/v2/group/{idOrShortName}/groups".format(idOrShortName=idOrShortName, group=group, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/group/{idOrShortName}/groups?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach_single_child_asset(
    ...
    url = "https://api.mnemonic.no/assets/v2/group/{idOrShortName}/assets/{assetIDOrShortName}".format(idOrShortName=idOrShortName, assetIDOrShortName=assetIDOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/group/{idOrShortName}/assets/{assetIDOrShortName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def detach_single_child_group(
    ...
    url = "https://api.mnemonic.no/assets/v2/group/{idOrShortName}/groups/{childGroupIDOrShortName}".format(idOrShortName=idOrShortName, childGroupIDOrShortName=childGroupIDOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/group/{idOrShortName}/groups/{childGroupIDOrShortName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_asset_groups(
    ...
    url = "https://api.mnemonic.no/assets/v2/group".format(limit=limit, customer=customer, group=group, keywords=keywords, offset=offset, includeDeleted=includeDeleted, startTimestamp=startTimestamp, endTimestamp=endTimestamp, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/group?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_asset_groups(
    ...
    url = "https://api.mnemonic.no/assets/v2/group/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/group/search"
...
def update_asset_group(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/group/{idOrShortName}"
