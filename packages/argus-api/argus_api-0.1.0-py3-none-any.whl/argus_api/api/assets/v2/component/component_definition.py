...
def add_component_definition(
    ...
    url = "https://api.mnemonic.no/assets/v2/component/definition".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/assets/v2/component/definition"
...
def delete_component_definition(
    ...
    url = "https://api.mnemonic.no/assets/v2/component/definition/{definition}".format(definition=definition, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/component/definition/{definition}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_component_definitions(
    ...
    url = "https://api.mnemonic.no/assets/v2/component/definition/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/component/definition/search"
...
def search_component_definitions_simplified(
    ...
    url = "https://api.mnemonic.no/assets/v2/component/definition".format(limit=limit, keywordMatch=keywordMatch, timeMatch=timeMatch, offset=offset, keywords=keywords, keywordField=keywordField, startTimestamp=startTimestamp, endTimestamp=endTimestamp, timeField=timeField, definition=definition, domain=domain, type=type, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/component/definition?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
