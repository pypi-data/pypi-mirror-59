...
def add_asset(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/assets/v2/asset"
...
def add_asset_definition(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset/definition".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/asset/definition"
...
def delete_asset(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset/{idOrShortName}".format(idOrShortName=idOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/asset/{idOrShortName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_asset_definition(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset/definition/{definition}".format(definition=definition, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/asset/definition/{definition}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_vulnerability_by_asset(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset/{asset}/vulnerability".format(asset=asset, customer=customer, includeRawOutput=includeRawOutput)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/asset/{asset}/vulnerability?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_vulnerability_by_asset_and_vulnerability_id(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset/{asset}/vulnerability/{vulnerabilityID}".format(asset=asset, vulnerabilityID=vulnerabilityID, customer=customer, includeRawOutput=includeRawOutput)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/asset/{asset}/vulnerability/{vulnerabilityID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_assets(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset".format(limit=limit, customer=customer, asset=asset, keywords=keywords, offset=offset, includeDeleted=includeDeleted, startTimestamp=startTimestamp, endTimestamp=endTimestamp, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/asset?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_asset_definitions(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset/definition/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/asset/definition/search"
...
def search_asset_definitions_simplified(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset/definition".format(limit=limit, keywordMatch=keywordMatch, timeMatch=timeMatch, offset=offset, keywords=keywords, keywordField=keywordField, startTimestamp=startTimestamp, endTimestamp=endTimestamp, timeField=timeField, definition=definition, domain=domain, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/assets/v2/asset/definition?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_assets(
    ...
    url = "https://api.mnemonic.no/assets/v2/asset/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/asset/search"
...
def update_asset(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/asset/{idOrShortName}"
...
def update_asset_definition(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/assets/v2/asset/definition/{definition}"
