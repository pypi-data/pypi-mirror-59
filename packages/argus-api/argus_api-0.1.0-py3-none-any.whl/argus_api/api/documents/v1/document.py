...
def commit_document(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}/commit".format(documentID=documentID)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/documents/v1/document/{documentID}/commit"
...
def get_document_content_by_id(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}/content".format(documentID=documentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/document/{documentID}/content?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_document_revisions(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}/versions".format(limit=limit, documentID=documentID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/document/{documentID}/versions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_meta_info_by_id(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}".format(documentID=documentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/document/{documentID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def grant_document_access(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}/access".format(documentID=documentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/document/{documentID}/access"
...
def list_document_access(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}/access".format(limit=limit, documentID=documentID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/document/{documentID}/access?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_documents(
    ...
    url = "https://api.mnemonic.no/documents/v1/document".format(limit=limit, customerID=customerID, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/document?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def lock_document(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}/lock".format(documentID=documentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/document/{documentID}/lock"
...
def move_document(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}/move".format(documentID=documentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/document/{documentID}/move"
...
def revoke_document_access(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/{documentID}/access/{accessID}".format(documentID=documentID, accessID=accessID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/document/{documentID}/access/{accessID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_documents(
    ...
    url = "https://api.mnemonic.no/documents/v1/document/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/document/search"
...
def update_document_1(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/document/{documentID}"
