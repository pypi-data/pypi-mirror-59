...
def add_document(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{folderID}/documents".format(folderID=folderID)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/documents/v1/folder/{folderID}/documents"
...
def add_folder(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{parentID}".format(parentID=parentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/folder/{parentID}"
...
def add_folder_by_path(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/path{parentFolderPath}".format(parentFolderPath=parentFolderPath, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/folder/path{parentFolderPath}"
...
def browse_folder(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{folderID}/content".format(limit=limit, offset=offset, folderID=folderID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/folder/{folderID}/content?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def browse_folder_by_path(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/path/content{path}".format(limit=limit, path=path, customer=customer, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/folder/path/content{path}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_folder(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{folderID}".format(mode=mode, folderID=folderID, cascadeDocumentID=cascadeDocumentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/folder/{folderID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_current_user_root_folder(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/root".format(limit=limit, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/folder/root?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_folder_meta_info_by_id(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{folderID}".format(folderID=folderID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def get_folder_meta_info_by_path(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/path/meta{path}".format(path=path, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/folder/path/meta{path}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def grant_folder_access(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{folderID}/access".format(folderID=folderID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/folder/{folderID}/access"
...
def grant_folder_access_by_path(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/path/access{path}".format(path=path, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/folder/path/access{path}"
...
def list_folder_access(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{folderID}/access".format(limit=limit, folderID=folderID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/folder/{folderID}/access?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_folder_access_by_path(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/path/access{path}".format(limit=limit, path=path, customer=customer, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/folder/path/access{path}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def move_folder(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{folderID}/move".format(folderID=folderID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/folder/{folderID}/move"
...
def revoke_folder_access(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/path/access{path}".format(path=path, customer=customer, accessID=accessID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def revoke_folder_access_1(
    ...
    url = "https://api.mnemonic.no/documents/v1/folder/{folderID}/access/{accessID}".format(folderID=folderID, accessID=accessID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/documents/v1/folder/{folderID}/access/{accessID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def update_folder(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/folder/{folderID}"
...
def update_folder_by_path(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/documents/v1/folder/path/meta{path}"
