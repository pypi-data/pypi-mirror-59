...
def disable_method_for_user(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/disable/{method}".format(userID=userID, method=method)
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/authentication/v1/user/{userID}/disable/{method}"
...
def download_public_key(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/signature/pubkey".format(userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/user/{userID}/signature/pubkey?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def enable_method_for_user(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/enable/{method}".format(userID=userID, method=method)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/user/{userID}/enable/{method}"
...
def get_user_methods(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userId}/methods".format(userId=userId)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/user/{userId}/methods?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def initiate(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/apikey".format(userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/user/{userID}/apikey"
...
def initiate_2(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/totp".format(userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/user/{userID}/totp"
...
def list(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/user/{userID}/apikey?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def renew(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/apikey/{prefix}".format(userID=userID, prefix=prefix)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/user/{userID}/apikey/{prefix}"
...
def renew_1(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/apikey/{keyID}".format(userID=userID, keyID=keyID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/user/{userID}/apikey/{keyID}"
...
def reset_and_download_private_key(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/signature/reset".format(userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/user/{userID}/signature/reset"
...
def retrieve_s_m_s_token(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/sms/token/{tokenSuffix}".format(userID=userID, tokenSuffix=tokenSuffix)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/user/{userID}/sms/token/{tokenSuffix}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def revoke(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/user/{userID}/apikey/{prefix}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def revoke_1(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/user/{userID}/apikey/{keyID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def revoke_4(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/user/{userID}/totp?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def setup(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/ldap".format(userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/user/{userID}/ldap"
...
def setup_1(
    ...
    url = "https://api.mnemonic.no/authentication/v1/user/{userID}/radius".format(userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/user/{userID}/radius"
