...
def initiate_1(
    ...
    url = "https://api.mnemonic.no/authentication/v1/apikey".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/authentication/v1/apikey"
...
def list_1(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/apikey?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def renew_2(
    ...
    url = "https://api.mnemonic.no/authentication/v1/apikey/{prefix}".format(prefix=prefix)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/apikey/{prefix}"
...
def renew_3(
    ...
    url = "https://api.mnemonic.no/authentication/v1/apikey/{keyID}".format(keyID=keyID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/apikey/{keyID}"
...
def revoke_2(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/apikey/{prefix}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def revoke_3(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/apikey/{keyID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
