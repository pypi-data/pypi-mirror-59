...
def authorize(
    ...
    url = "https://api.mnemonic.no/authentication/v1/oauth/authorize".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/authentication/v1/oauth/authorize"
...
def create_o_auth2_client(
    ...
    url = "https://api.mnemonic.no/authentication/v1/oauth/client".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/oauth/client"
...
def delete_oauth2_client(
    ...
    url = "https://api.mnemonic.no/authentication/v1/oauth/client/{idOrShortname}".format(idOrShortname=idOrShortname)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/oauth/client/{idOrShortname}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_token(
    ...
    url = "https://api.mnemonic.no/authentication/v1/oauth/token".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def update_o_auth2_client(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/oauth/client/{idOrShortname}"
