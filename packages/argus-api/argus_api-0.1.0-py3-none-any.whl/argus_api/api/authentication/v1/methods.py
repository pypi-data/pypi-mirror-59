...
def get_methods(
    ...
    url = "https://api.mnemonic.no/authentication/v1/methods".format()
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/methods?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
