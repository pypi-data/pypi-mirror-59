...
def authenticate_4(
    ...
    url = "https://api.mnemonic.no/authentication/v1/totp/authenticate".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/authentication/v1/totp/authenticate"
...
def initialize(
    ...
    url = "https://api.mnemonic.no/authentication/v1/totp".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/authentication/v1/totp"
...
def revoke_5(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/authentication/v1/totp?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
