...
def lookup_i_p(
    ...
    url = "https://api.mnemonic.no/geoip/v1/ip/{address}".format(address=address)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/geoip/v1/ip/{address}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
