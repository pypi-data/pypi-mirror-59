...
def get_location(
    ...
    url = "https://api.mnemonic.no/geoip/v1/location/{id}".format(id=id)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/geoip/v1/location/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
