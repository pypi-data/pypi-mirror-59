...
def grant_permission(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/permission".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/useradmin/v2/permission"
...
def list_permissions(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/permission?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def revoke_permission(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/permission/{permissionID}".format(permissionID=permissionID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/permission/{permissionID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_permissions(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/permission/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/permission/search"
