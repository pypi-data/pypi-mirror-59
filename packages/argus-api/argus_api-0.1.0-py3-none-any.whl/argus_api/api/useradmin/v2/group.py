...
def add_group(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/group".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/useradmin/v2/group"
...
def add_group_members(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}/members".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}/members"
...
def delete_group(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_groups_1(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/group".format(limit=limit, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/group?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_permissions_for_group(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}/permissions".format(limit=limit, includeInherited=includeInherited, shortNameOrID=shortNameOrID, domain=domain, offset=offset, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}/permissions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_subjects_in_group(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}/members?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def reenable_group(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}/reenable".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}/reenable"
...
def remove_subjects_from_group(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}/members".format(shortNameOrID=shortNameOrID, domain=domain, subject=subject)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def search_groups(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/group/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/group/search"
...
def update_group(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/group/{shortNameOrID}"
