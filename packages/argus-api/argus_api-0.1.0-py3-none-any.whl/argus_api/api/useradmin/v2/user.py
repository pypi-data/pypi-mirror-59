...
def add_user(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/useradmin/v2/user"
...
def delete_user_1(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def delete_user_preferences(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences".format(shortNameOrID=shortNameOrID, domain=domain, key=key)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_user_image_1(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/picture".format(shortNameOrID=shortNameOrID, domain=domain, width=width, height=height, default=default)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/picture?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_user_preference(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences/{key}".format(shortNameOrID=shortNameOrID, key=key, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences/{key}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_permissions_for_user(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/permissions".format(limit=limit, includeInherited=includeInherited, shortNameOrID=shortNameOrID, domain=domain, offset=offset, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/permissions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_user_preference_as_map(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferencemap".format(limit=limit, offset=offset, shortNameOrID=shortNameOrID, domain=domain, key=key)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferencemap?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_user_preferences(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences".format(limit=limit, offset=offset, shortNameOrID=shortNameOrID, domain=domain, key=key)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def list_users_1(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user".format(limit=limit, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/user?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def reenable_user(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/reenable".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/reenable"
...
def reset_password(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/resetpassword".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/resetpassword"
...
def search_users(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/user/search"
...
def set_user_image(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/picture".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/picture"
...
def set_user_preference(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences/{key}/{value}".format(shortNameOrID=shortNameOrID, domain=domain, key=key, value=value)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences/{key}/{value}"
...
def set_user_preferences(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/preferences"
...
def unblock_user(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/unblock".format(shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}/unblock"
...
def update_user(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/user/{shortNameOrID}"
