...
def add_function(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/function".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/useradmin/v2/function"
...
def add_function_child(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}/children".format(functionNameOrID=functionNameOrID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}/children"
...
def delete_user(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}".format(functionNameOrID=functionNameOrID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_function_children(
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}/children?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_function_parents(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}/parents".format(functionNameOrID=functionNameOrID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}/parents?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_functions(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/function".format(limit=limit, keywordMatch=keywordMatch, offset=offset, function=function, minimumSecurityLevel=minimumSecurityLevel, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, ancestor=ancestor, descendant=descendant, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/useradmin/v2/function?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def remove_function_child(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}/children".format(functionNameOrID=functionNameOrID, child=child)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def search_functions(
    ...
    url = "https://api.mnemonic.no/useradmin/v2/function/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/function/search"
...
def update_function(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/useradmin/v2/function/{functionNameOrID}"
