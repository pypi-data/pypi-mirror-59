...
def get_component_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/component/{componentID}".format(componentID=componentID)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v2/status/component/{componentID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_host_instances(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/host/{host}/instances".format(limit=limit, host=host, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v2/status/host/{host}/instances?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_host_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/host/{host}".format(host=host)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v2/status/host/{host}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_instance_status_1(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/instance/{instanceID}".format(instanceID=instanceID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v2/status/instance/{instanceID}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_status_overview(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v2/status?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_component_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/component".format(limit=limit, componentType=componentType, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v2/status/component?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_host_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/host".format(limit=limit, instanceState=instanceState, hostState=hostState, offset=offset, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v2/status/host?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_instance_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/instance".format(limit=limit, instanceState=instanceState, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v2/status/instance?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_component_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/component/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/componentadmin/v2/status/component/search"
...
def search_host_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/host/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v2/status/host/search"
...
def search_instance_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v2/status/instance/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v2/status/instance/search"
...
def update_host_status(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v2/status"
...
def update_instance_status(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v2/status/instance/{instanceID}"
