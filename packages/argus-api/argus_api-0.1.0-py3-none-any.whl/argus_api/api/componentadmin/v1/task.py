...
def get_task(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/task/{id}".format(id=id)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v1/task/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_tasks(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/task".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v1/task?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
