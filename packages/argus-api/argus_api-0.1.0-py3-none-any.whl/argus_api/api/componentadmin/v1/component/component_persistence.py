...
def delete_component_persistence(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/component/{componentID}/persistence".format(componentID=componentID)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v1/component/{componentID}/persistence?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
