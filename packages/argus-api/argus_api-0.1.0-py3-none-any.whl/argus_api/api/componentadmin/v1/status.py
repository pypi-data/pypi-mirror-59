...
def clear_component_directory(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/status".format()
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v1/status?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def refresh(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/status/refresh".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/componentadmin/v1/status/refresh"
