...
def get_container_performance(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/instance/{id}/performance".format(id=id)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v1/instance/{id}/performance?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_instance_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/instance/{id}/status".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/componentadmin/v1/instance/{id}/status?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def install(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/instance/{id}/install".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/componentadmin/v1/instance/{id}/install"
...
def reboot_1(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/instance/{id}/reboot".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v1/instance/{id}/reboot"
...
def refresh_instance_status(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/instance/{id}/status/refresh".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v1/instance/{id}/status/refresh"
...
def start(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/instance/{id}/start".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v1/instance/{id}/start"
...
def stop(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/instance/{id}/stop".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v1/instance/{id}/stop"
...
def uninstall(
    ...
    url = "https://api.mnemonic.no/componentadmin/v1/instance/{id}/uninstall".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/componentadmin/v1/instance/{id}/uninstall"
