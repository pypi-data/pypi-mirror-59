...
def error_stats(
    ...
    url = "https://api.mnemonic.no/eventfilters/v1/filter/errorstats".format(includeDetails=includeDetails)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/eventfilters/v1/filter/errorstats?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get(
    ...
    url = "https://api.mnemonic.no/eventfilters/v1/filter/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/eventfilters/v1/filter/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def hit_stats(
    ...
    url = "https://api.mnemonic.no/eventfilters/v1/filter/hitstats".format(period=period, includeDetails=includeDetails)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/eventfilters/v1/filter/hitstats?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list(
    ...
    url = "https://api.mnemonic.no/eventfilters/v1/filter".format(limit=limit, offset=offset, search=search, customerID=customerID, type=type)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/eventfilters/v1/filter?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def revisions(
    ...
    url = "https://api.mnemonic.no/eventfilters/v1/filter/{id}/revisions".format(limit=limit, offset=offset, id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/eventfilters/v1/filter/{id}/revisions?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search(
    ...
    url = "https://api.mnemonic.no/eventfilters/v1/filter/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/eventfilters/v1/filter/search"
...
def set_log_level(
    ...
    url = "https://api.mnemonic.no/eventfilters/v1/filter/{id}/logging".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/eventfilters/v1/filter/{id}/logging"
