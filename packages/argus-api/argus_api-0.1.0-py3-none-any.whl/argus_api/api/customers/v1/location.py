...
def get_customer_locations(
    ...
    url = "https://api.mnemonic.no/customers/v1/location".format(limit=limit, customerID=customerID, keywords=keywords, offset=offset)
    headers = {
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customers/v1/location?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
