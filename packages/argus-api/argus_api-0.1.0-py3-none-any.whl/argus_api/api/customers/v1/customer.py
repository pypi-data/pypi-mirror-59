...
def add_customer(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer".format()
    headers = {
    ...
    log.debug(
        ...
        "https://api.mnemonic.no/customers/v1/customer"
...
def add_customer_service(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer/{customerID}/service".format(customerID=customerID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/customers/v1/customer/{customerID}/service"
...
def disable_customer(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer/{id}".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customers/v1/customer/{id}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_customer_by_shortname(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer/{shortName}".format(shortName=shortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customers/v1/customer/{shortName}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_customer_logo_by_id(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer/{id}/logo".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customers/v1/customer/{id}/logo?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def get_customer_logo_by_shortname(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer/{shortName}/logo".format(shortName=shortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customers/v1/customer/{shortName}/logo?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def list_customers(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer".format(limit=limit, keywordMatch=keywordMatch, offset=offset, parentID=parentID, service=service, keywords=keywords, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customers/v1/customer?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def reenable_customer(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer/{id}/reenable".format(id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/customers/v1/customer/{id}/reenable"
...
def remove_customer_service(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer/{customerID}/service/{service}".format(customerID=customerID, service=service)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        ' "%s"' % ("https://api.mnemonic.no/customers/v1/customer/{customerID}/service/{service}?" + "&".join(["%s=%s" % (key, str(value)) for key,value in body.items()]))
...
def search_customers(
    ...
    url = "https://api.mnemonic.no/customers/v1/customer/search".format()
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/customers/v1/customer/search"
...
def update_customer(
    ...
    log.debug(
        ...
        (("-d '%s' " % str(body)) if body else " ") +
        "https://api.mnemonic.no/customers/v1/customer/{id}"
