        ...
        for clusi in range(len(orderedClusters)):
            ...
            if topExp_run is not None:
                ...
                if alixe:
                    ...
                    # NOTE CM: ali_confdict must have all the settings ready.
                    # NOTE CM: this should be done by reading the information of the defaults in a function
                    ...
                    if alixe_mode == 'monomer':
                        tuple_phi, ali_confdict = al.startALIXEforARCIMBOLDO_OneStep(ali_confdict, input_mode, current_directory,
                                                                       clust_fold_rotclu,
                                                                       runstring)
                        ...
                        for clu in evaluated_clusters:
                            #print('\n*** SHERLOCK clu', clu)
                            #print('\n*** SHERLOCK evaluated_clusters',evaluated_clusters)
                            ...
                            #print('\n \n *****SHERLOCK checking path_pickle',path_pickle)
                            if not os.path.exists(path_pickle):
                                #print('SHERLOCK tenemos que lanzar este clustering one step primero')
                        ...
                        print('SHERLOCK Multimer mode pending to implement')
                        quit()
