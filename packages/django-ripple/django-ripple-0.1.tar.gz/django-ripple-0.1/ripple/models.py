...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def send_password_reset_email(self):
        ...
        # TODO red - check reverse proxy behaviour with domain
        ...
        msg_plain = render_to_string(
            'password_reset_email.txt', email_context)
        msg_html = render_to_string(
            'password_reset_email.html', email_context)

        # TODO red - how does ___rippleweb___ work?
        filtered_send_mail(
            'Password Reset Ripple Energy',
            msg_plain,
