...
class S3Manager(object):
  ...
  def upload_object(self,
    ...
    return self.generate_object_url(bucket_name,
                                    obj_key,
  ...
  def upload_img_bin(self,
    ...
    Args:
      ...
      img_format: file type of the image.
      img_key: key for the image object.
    ...
    self.client.upload_fileobj(io.BytesIO(img_bin),
                               bucket_name,
                               img_key,
                               ExtraArgs=upload_args)
    return self.generate_object_url(bucket_name, img_key, make_public)
