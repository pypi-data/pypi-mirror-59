...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        factorial_component = math.factorial(self.n)/(math.factorial(self.n-k)*math.factorial(k))
        probability_component= (self.p**(k))*(1-self.p)**(self.n-k)
        return factorial_component*probability_component
    ...
    def plot_bar_pdf(self):
        ...
        x_val=list(range(0,self.n+1))
        y_val=[self.pdf(i) for i in x_val]
        plt.bar(x_val,y_val)
        plt.xlabel("Chances of Heads from total draws")
    ...
    def __add__(self, other):
        ...
        try:
            ...
            new_var=Binomial()
            new_var.p=self.p
            new_var.n=self.n+other.n
            new_var.mean=new_var.calculate_mean()
            new_var.stdev=new_var.calculate_stdev()
            return new_var
        except AssertionError as error:
            raise "values not appear equal" 
