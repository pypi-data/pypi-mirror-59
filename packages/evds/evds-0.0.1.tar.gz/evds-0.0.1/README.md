# EVDS
EVDS paketi EVDS-API üzerinden Türkiye Cumhuriyet Merkez Bankası (TCMB) tarafından Eletronik Veri Dağıtım Sistemi (EVDS) aracılığıyla yayımlanan istatistiki verilere python aracılığıyla erişmenize imkan sağlar.
