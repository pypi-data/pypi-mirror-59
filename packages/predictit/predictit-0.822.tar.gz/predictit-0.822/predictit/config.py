...
data = 0  # Use numpy array, or pandas dataframe. This will overwrite data_source. If you use csv, set up to 0 or False.
...
predicted_column = 1  # Name of predicted column (for dataframe data) or it's index - string or int
