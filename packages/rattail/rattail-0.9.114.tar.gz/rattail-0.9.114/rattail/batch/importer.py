...
class ImporterBatchHandler(BatchHandler):
    ...
    # TODO: is it really a good idea for this handler to define these values?
    # seems like maybe a setting would be better, and/or it would depend on the
    # actual importer in question, etc.
