...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.3.0-alpha.1579304739+g506afa5b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.3.0-alpha.1579304739+g506afa5b`
                """)
            else:
                raise
