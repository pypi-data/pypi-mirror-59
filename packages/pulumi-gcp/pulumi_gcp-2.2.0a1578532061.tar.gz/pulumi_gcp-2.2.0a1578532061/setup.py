...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.2.0-alpha.1578532061+gbeb1c2ec'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.2.0-alpha.1578532061+gbeb1c2ec`
                """)
            else:
                raise
